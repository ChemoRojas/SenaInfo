...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var filter = $('<div/>', {
			...
			.append($('<label class="col-md-12 no-padding"/>').append(str));
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 */
			"sSearchPlaceholder": "Ingrese un dato",
			 ...
			 *    } );
			 */
			"sZeroRecords": "No se encuentran registros según filtro aplicado"
		},
	...
	$.extend( DataTable.ext.classes, {
		...
		"sPageButtonActive": "current",*/ //gfontbrevis
		"sPageButton": "btn btn-sm",
		"sPageButtonActive": "btn-danger",
		...
		"sFilter": "dataTables_filter col-md-6 no-padding",
		...
		/* Filtering */
		"sFilterInput": "form-control datatable-filtro input-sm",//gfontbrevis
	
		/* Page length */
		"sLengthSelect": "form-control datatable-mostrar input-sm",//gfontbrevis
