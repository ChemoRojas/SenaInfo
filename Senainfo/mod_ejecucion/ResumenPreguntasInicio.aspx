<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResumenPreguntasInicio.aspx.cs" Inherits="mod_ejecucion_ResumenPreguntasInicio" %>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <asp:GridView ID="grdPlanificarModulo" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="table table table-bordered table-hover"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="Total" HeaderText="Total de puntaje" />
                                                <asp:BoundField DataField="Porcentaje" HeaderText="Porcentaje" dataformatstring="{0:0.00}%"/>
