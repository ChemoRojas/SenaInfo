...
public partial class mod_ejecucion_ResumenPreguntasFin : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            getIActividadesModulosNNA("1","2", Request["CodNino"], Request["CodCalendario"]);
    ...
    private void getIActividadesModulosNNA(string TipoRespuesta,string TipoRespuesta2, string CodNino, string CodCalendario)
    {
        ...
        sqlc.CommandText = "[dbo].[SP_CuadroFinal]";
        sqlc.Parameters.Add("@TipoRespuesta", SqlDbType.VarChar, 100).Value = TipoRespuesta;
        sqlc.Parameters.Add("@TipoRespuesta2", SqlDbType.VarChar, 100).Value = TipoRespuesta2;
