<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Evaluacion_Inicial.aspx.cs" Inherits="mod_ejecucion_Evaluacion_Inicial" %>
                        ...
                        <div class="well">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <h4 class="subtitulo-form">listado</h4>
                                        ...
                                        <asp:GridView ID="grdPlanificarModulo" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="table table table-bordered table-hover"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:hyperlinkfield text="Evaluar" datanavigateurlfields="CodModulo,CodNino,CodCalendario" datanavigateurlformatstring="PreguntasInicio.aspx?CodModulo={0}&CodNino={1}&CodCalendario={2}" HeaderText="Acción" ItemStyle-HorizontalAlign="Center" />
