<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Evaluacion_Final.aspx.cs" Inherits="mod_ejecucion_Evaluacion_Final" %>
                                ...
                                <div class="col-md-12">
                                        ...
                                        <asp:GridView ID="grdPlanificarModulo" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="table table table-bordered table-hover"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:hyperlinkfield text="Evaluar" datanavigateurlfields="CodModulo,CodNino,CodCalendario" datanavigateurlformatstring="PreguntasFinal.aspx?CodModulo={0}&CodNino={1}&CodCalendario={2}" HeaderText="Acción" ItemStyle-HorizontalAlign="Center" />
