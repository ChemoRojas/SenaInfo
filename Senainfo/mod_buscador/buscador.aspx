                                            ...
                                            <asp:Label ID="lbl002" runat="server">0</asp:Label></label></h4>
                                                    ...
                                                    <asp:GridView ID="grdBusqueda" runat="server" AutoGenerateColumns="False" CellPadding="4" GridLines="None" CssClass="table table table-bordered table-hover"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:hyperlinkfield text="Detalle..." datanavigateurlfields="CodNino,Ruc" datanavigateurlformatstring="detalleNNA.aspx?CodNino={0}&amp;Ruc={1}" HeaderText="Seleccionar" ItemStyle-HorizontalAlign="Center" />
                                                        </Columns>
                                                    </asp:GridView>
