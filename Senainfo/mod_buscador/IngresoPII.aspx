<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IngresoPII.aspx.cs" Inherits="mod_buscador_IngresoPII" %>
                                ...
                                <div class="col-md-9">
                                    <table class="table table-borderless table-condensed table-col-fix">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <asp:DropDownList ID="ddlEod" CssClass="selectpicker show-menu-arrow" data-style="btn-info" data-live-search="true" data-width="auto" runat="server" AutoPostBack="True">
                                                    </asp:DropDownList>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <asp:DropDownList ID="ddlPic" CssClass="selectpicker show-menu-arrow" data-style="btn-info" data-live-search="true" data-width="auto" runat="server">
                                                    </asp:DropDownList>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <asp:DropDownList ID="ddlEtd" CssClass="selectpicker show-menu-arrow" data-style="btn-info" data-live-search="true" data-width="auto" runat="server">
                                                    </asp:DropDownList>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <asp:DropDownList ID="ddlTo" CssClass="selectpicker show-menu-arrow" data-style="btn-info" data-live-search="true" data-width="auto" runat="server">
                                                    </asp:DropDownList>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <asp:DropDownList ID="ddlCF" CssClass="selectpicker show-menu-arrow" data-style="btn-info" data-live-search="true" data-width="auto" runat="server">
                                                    </asp:DropDownList>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <asp:DropDownList ID="ddlEpe" CssClass="selectpicker show-menu-arrow" data-style="btn-info" data-live-search="true" data-width="auto" runat="server">
                                                    </asp:DropDownList>
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <table class="table table-borderless table-condensed table-col-fix">
                                    <tr>
                                            <asp:LinkButton ID="btnGuardar" runat="server" CssClass="btn btn-info btn-sm" OnClick="btnGuardar_Click">
                                                <span class="glyphicon glyphicon-cloud-upload"></span>&nbsp;Guardar
                                            </asp:LinkButton>
                                    </tr>
                                </table>
