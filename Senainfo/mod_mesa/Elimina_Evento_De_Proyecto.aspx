 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="Elimina_Evento_De_Proyecto.aspx.cs" Inherits="mod_mesa_Elimina_Evento_De_Proyecto" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="container theme-showcase" role="main">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Elimina Evento de Proyecto</li>
                        </ol>
                        ...
                        <div class="well">
                            <h4 class="subtitulo-form">Mesa de Ayuda Elimina Evento de Proyecto</h4>
                            <hr />
                            <div class="row">
                                <div class="col-md-9">
                                    <table class="table table-bordered table-condensed">
                                        <uc1:C_codigoeventoproyecto runat="server" ID="C_codigoeventoproyecto" UsarTabla="false" />
                                        <tr>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="panel-info panel-primary-info">
                                        ...
                                        <div class="panel-footer">
                                            <asp:Label ID="lbl_info" CssClass="subtitulo-form-info" runat="server" Text="Identifique el evento de proyecto que desea eliminar de acuerdo a los parámetros indicados.En el campo “comentario”, debe incorporar información relativa con el origen de la solicitud."></asp:Label>
                                        </div>
                                    </div>
