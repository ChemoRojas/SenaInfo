<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Elimina_persona_relacionada_ingreso.aspx.cs" Inherits="mod_mesa_C_Elimina_persona_relacionada_ingreso" %><%@ Register src="~/SenainfoSdk/C_seleccionIcodie.ascx" tagname="C_seleccionIcodie" tagprefix="uc1" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/menu_colgante.ascx" TagPrefix="uc1" TagName="menu_colgante" %>
<%@ Register Src="~/SenainfoSdk/C_buscaPersonaRelacionada.ascx" TagPrefix="uc1" TagName="C_buscaPersonaRelacionada" %>
            ...
            <ContentTemplate>
                ...
                <div class="container theme-showcase" role="main">
                     <ol class="breadcrumb">
                        ...
                        <li class="active">Elimina Persona Relacionada Ingreso</li>
                    </ol>
                    ...
                    <div class="well">
                        <h4 class="subtitulo-form">Mesa de Ayuda Elimina Persona Relacionada</h4>
                        <hr />
                        <div class="row">
                            <div class="col-md-9">
                                <table class="table table-bordered table-condensed">
                                    <uc1:C_buscaPersonaRelacionada runat="server" ID="C_buscaPersonaRelacionada" UsarTabla="false" OnCodPersonaRelacionadaSeleccionadoCambio="C_buscaPersonaRelacionada_CodPersonaRelacionadaSeleccionadoCambio" />
                                    <tr>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="panel-info panel-primary-info">
                                    ...
                                    <div class="panel-footer">
                                        <asp:Label ID="lbl_info" CssClass="subtitulo-form-info" runat="server" Text="Identifique al NNA del proyecto y a la <b>“persona relacionada”</b> que desea eliminar. En el campo “comentario”, debe incorporar información relativa con el origen de la solicitud."></asp:Label>
                                    </div>
                                </div>
