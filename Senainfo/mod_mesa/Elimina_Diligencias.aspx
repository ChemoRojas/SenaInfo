<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Elimina_Diligencias.aspx.cs" Inherits="mod_mesa_Elimina_Diligencias" %>

<%@ Register src="~/SenainfoSdk/C_codplandiligencia.ascx" tagname="C_codplandiligencia" tagprefix="uc1" %>
            ...
            <ContentTemplate>
                ...
                <div class="container theme-showcase" role="main">
                      <ol class="breadcrumb">
                        ...
                        <li class="active">Elimina Diligencia</li>
                    </ol>
                    ...
                    <div class="well">
                        <h4 class="subtitulo-form">Mesa de Ayuda Elimina Diligencias</h4>
                        <hr />
                        <div class="row">
                            <div class="col-md-9">
                                <table class="table table-bordered table-condensed">
                                    <uc1:C_codplandiligencia ID="C_codplandiligencia1" runat="server" OnCoddiligenciaSeleccionadoCambio="C_codplandiligencia1_CoddiligenciaSeleccionadoCambio" UsarTabla="false" />
                                    <tr>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="panel-info panel-primary-info">
                                    ...
                                    <div class="panel-footer">
                                        <asp:Label ID="lbl_info" CssClass="subtitulo-form-info" runat="server" Text="Identifique al NNA  y la diligencia que desea eliminar de acuerdo a los parámetros indicados. En el campo “comentario”, debe incorporar información relativa con el origen de la solicitud."></asp:Label>
                                    </div>
                                </div>
