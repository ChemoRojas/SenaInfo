<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Elimina_ingreso.aspx.cs" Inherits="mod_mesa_Elimina_ingreso" %>
            ...
            <ContentTemplate>
                ...
                <div class="container theme-showcase" role="main">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Elimina Ingreso</li>
                    </ol>
                    ...
                    <div class="well">
                        <h4 class="subtitulo-form">Mesa de Ayuda Elimina Ingreso</h4>
                        <hr />
                        <div class="row">
                            <div class="col-md-9">
                                <table class="table table-bordered table-condensed">
                                    <uc1:C_seleccionIcodie ID="C_seleccionIcodie1" runat="server" OnICODIECambio="C_seleccionIcodie1_ICODIECambio" UsarTabla="false" />
                                    <tr>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="panel-info panel-primary-info">
                                    ...
                                    <div class="panel-footer">
                                        <asp:Label ID="Label1" CssClass="subtitulo-form-info" runat="server" Text="Identifique al NNA del proyecto junto a su IcodIE. Recuerde que este procedimiento elimina solo al NNA del proyecto. Cerciórese de que el NNA no tenga eventos de intervención asociados y de que el mes se encuentre abierto.  En el campo “comentario”, debe incorporar información relativa con el origen de la solicitud."></asp:Label>
                                    </div>
                                </div>
