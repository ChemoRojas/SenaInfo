<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Modifica Fecha de Ingreso del NNA.aspx.cs" Inherits="mod_mesa_Regenerar_10_ActualizaFecha" %>
                ...
                <ContentTemplate>
                    <div class="container theme-showcase" role="main">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Modifica Fecha de Ingreso del NNA</li>
                        </ol>
                        ...
                        <div class="well">
                            <h4 class="subtitulo-form">Mesa de Ayuda Modifica Fecha de Ingreso del NNA</h4>
                            <hr />
                            <div class="row">
                                <div class="col-md-9">
                                    <table class="table table-bordered table-condensed">
                                        <uc1:C_seleccionIcodie ID="C_seleccionIcodie1" runat="server" UsarTabla="false" />
                                        <tr>
                                            <th class="titulo-tabla col-md-1">Ingrese una Fecha *</th>
                                            <td>

                                                <asp:TextBox ID="cal_inicio" runat="server" CssClass="form-control form-control-fecha-large input-sm" EDITABLE="False" placeholder="dd-mm-aaaa" OnTextChanged="cal_inicio_TextChanged" AutoPostBack="true" />
                                ...
                                <div class="panel-info panel-primary-info">
                                    ...
                                    <div class="panel-footer">
                                        <asp:Label ID="Label1" CssClass="subtitulo-form-info" runat="server" Text="Identifique al NNA del proyecto y la NUEVA fecha de ingreso. En el campo “comentario”, debe incorporar información relativa con el origen de la solicitud."></asp:Label>
                                    </div>
                                </div>
