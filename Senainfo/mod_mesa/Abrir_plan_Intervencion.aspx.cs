...
public partial class mod_mesa_Abrir_plan_Intervencion : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            if (!window.existetoken("999A585B-80C4-45BC-8DCA-6F6213DA7D2C"))
            {
    ...
    private bool EntradaValida()
    {
        ...
        if (this.C_codplanIntervencion1.CodPlanIntervencion == 0)
        {
            ...
            mensaje = "Debe seleccionar un PII. ";
        ...
        if (this.txt_comentario.Text == "")
        {
            valido = false;

            mensaje += "Debe Ingresar un comentario. ";

            this.txt_comentario.CssClass = SenainfoSdk.UI.Util.AddCssClass(this.txt_comentario.CssClass,
                    "campo-obligatorio");
        }
        else
        {
    ...
    private void ExecProcedimiento(int confirmar)
    {
        ...
        try
        {
            ...
            sqlc.CommandText = "Mesa_pii_abrir";
            var returnParameter = sqlc.Parameters.Add("@ReturnVal", SqlDbType.Int);
            returnParameter.Direction = ParameterDirection.ReturnValue;
            sqlc.Parameters.Add("@codplanintervencion", SqlDbType.Int).Value = C_codplanIntervencion1.CodPlanIntervencion; 
            ...
            if (confirmar == 0)
            {
                ...
                {
                    case 0: //exito
                        this.C_modalPopUp.ShowMensaje("Confirmar Abrir Plan de Intervención",
                            this.msgsp,
    ...
    private void registrolog()
    {
        ...
        logreg.nombre_sp_ejecutado = "Mesa_pii_abrir";
        logreg.insertLog();
    }
