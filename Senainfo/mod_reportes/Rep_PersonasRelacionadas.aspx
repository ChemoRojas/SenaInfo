<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rep_PersonasRelacionadas.aspx.cs" Inherits="mod_reportes_Rep_Diag_Ninos_Rep_PersonasRelacionadas" %>
...
<head id="Head1" runat="server">
    ...
    <title>Reporte Personas Relacionadas :: Senainfo :: Servicio Nacional de Menores</title>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                ...
                <h5 class="subtitulo-form">Reporte Personas Relacionadas
                            <asp:Label ID="lbl_titulo_cabezera" runat="server"></asp:Label>
                </h5>
                <div class="row">
                    <div class="col-md-9">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        ...
                                        <asp:LinkButton ID="imb_institucion" CssClass="input-group-addon btn btn-info btn-sm" OnClientClick="return MostrarModalInstitucion('Plan%20de%20Intervencion','../mod_reportes/Rep_PersonasRelacionadas.aspx','mpe1a')" runat="server" CausesValidation="False">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        ...
                                        <asp:LinkButton ID="imb_proyecto" CssClass="input-group-addon btn btn-info btn-sm" OnClientClick="return MostrarModalProyecto('Busca Proyectos','../mod_reportes/Rep_PersonasRelacionadas.aspx','mpe2a')" runat="server" CausesValidation="False">
                                                <span class="glyphicon glyphicon-question-sign"></span>
                                        </asp:LinkButton>
                                    </div>
                                </td>
                ...
                <div class="col-md-12  table-responsive">
                    <asp:GridView ID="grd001" runat="server" CssClass="table  table-bordered table-hover " AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="grd001_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Padre" HeaderText="Padre"></asp:BoundField>
                            <asp:BoundField DataField="NacionalidadPadre" HeaderText="Nacionalidad Padre"></asp:BoundField>
                            <asp:BoundField DataField="Madre" HeaderText="Madre"></asp:BoundField>
                            <asp:BoundField DataField="NacionalidadMadre" HeaderText="Nacionalidad Madre"></asp:BoundField>
                            <asp:BoundField DataField="Otro" HeaderText="Otro"></asp:BoundField>
                        </Columns>
