<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DIAG_PEORES_FORMA.ascx.cs" Inherits="mod_reportes_Rep_Diag_Ninos_DIAG_PEORES_FORMA" %>
...
<asp:GridView ID="grd001" runat="server" AllowPaging="True" AutoGenerateColumns="False"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="ICodPeoresFormas" HeaderText="Cod. PeoresFormas">
            <ItemStyle Font-Size="11px" />
        </asp:BoundField>
        <asp:BoundField DataField="CodDiagnostico" HeaderText="Cod. Diagnostico">
            <ItemStyle Font-Size="11px" />
        </asp:BoundField>
        <asp:BoundField DataField="PresentaAgresion" HeaderText="Presenta Agresion">
            <ItemStyle Font-Size="11px" />
        </asp:BoundField>
        <asp:BoundField DataField="CategoriasPFMI" HeaderText="Categorias PFMI">
            <ItemStyle Font-Size="11px" />
        </asp:BoundField>
        <asp:BoundField DataField="ViveConExplotador" HeaderText="Vive Con Explotador" />
