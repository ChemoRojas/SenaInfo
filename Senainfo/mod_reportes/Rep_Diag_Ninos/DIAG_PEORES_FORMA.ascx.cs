...
public partial class mod_reportes_Rep_Diag_Ninos_DIAG_PEORES_FORMA : System.Web.UI.UserControl
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        dt.Columns[10].ColumnName = "COD. PEORES FORMAS";	//10
        dt.Columns[11].ColumnName = "COD. DIAGNOSTICO";	            //11
        dt.Columns[12].ColumnName = "PRESENTA AGRESION";	//12
        dt.Columns[13].ColumnName = "CATEGORIAS PFMI";	//13
        dt.Columns[14].ColumnName = "VIVE CON EXPLOTADOR";	//13
