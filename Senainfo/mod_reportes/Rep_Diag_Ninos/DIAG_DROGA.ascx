<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DIAG_DROGA.ascx.cs" Inherits="mod_reportes_Rep_Diag_Ninos_DIAG_DROGA" %>
...
<asp:GridView ID="grd001" runat="server" AllowPaging="True" AutoGenerateColumns="False"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="ICodDroga" HeaderText="Cod. Droga">
            <ItemStyle Font-Size="11px" />
        </asp:BoundField>
        ...
        <asp:BoundField DataField="Droga" HeaderText="Droga">
            <ItemStyle Font-Size="11px" />
        </asp:BoundField>
        <asp:BoundField DataField="TipoConsumoDroga" HeaderText="Tipo Consumo Droga" HtmlEncode="False">
        ...
        <asp:BoundField DataField="SeAtiendeCONACE" HeaderText="SeAtiende CONACE">
            <ItemStyle Font-Size="11px" />
        </asp:BoundField>
    </Columns>
