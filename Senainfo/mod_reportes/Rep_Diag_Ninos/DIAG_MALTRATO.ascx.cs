...
public partial class mod_reportes_Rep_Diag_Ninos_DIAG_MALTRATO : System.Web.UI.UserControl
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        dt.Columns[10].ColumnName = "COD. MALTRATO";	//10
        dt.Columns[11].ColumnName = "COD. DIAGNOSTICO";//11
        dt.Columns[12].ColumnName = "TIPO MALTRATO";	//12
        dt.Columns[13].ColumnName = "MALTRATO";	//12
        dt.Columns[14].ColumnName = "TIPO RELACION";	//13
        dt.Columns[15].ColumnName = "RELACION MALTRATADOR";	//13
        dt.Columns[16].ColumnName = "TECNICO";		    //14
        dt.Columns[17].ColumnName = "FECHA ACTUALIZACION";//15
        dt.Columns[18].ColumnName = "PRESENTA MALTRATO";//15
