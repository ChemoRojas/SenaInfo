<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DIAG_MALTRATO.ascx.cs" Inherits="mod_reportes_Rep_Diag_Ninos_DIAG_MALTRATO" %>
...
<asp:GridView ID="grd001" runat="server" AllowPaging="True" AutoGenerateColumns="False"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="ICodMaltrato" HeaderText="Cod. Maltrato">
            <ItemStyle Font-Size="11px" />
        </asp:BoundField>
        <asp:BoundField DataField="CodDiagnostico" HeaderText="Cod. Diagnostico">
            <ItemStyle Font-Size="11px" />
        </asp:BoundField>
        <asp:BoundField DataField="TipoMaltrato" HeaderText="Tipo Maltrato">
            <ItemStyle Font-Size="11px" />
        </asp:BoundField>
        <asp:BoundField DataField="Maltrato" HeaderText="Maltrato">
            <ItemStyle Font-Size="11px" />
        </asp:BoundField>
        <asp:BoundField DataField="RelacionMaltratador" HeaderText="Relacion Maltratador">
            <ItemStyle Font-Size="11px" />
        </asp:BoundField>
        ...
        <asp:BoundField DataField="PresentaMaltrato" HeaderText="Presenta Maltrato">
            <ItemStyle Font-Size="11px" />
        </asp:BoundField>
    </Columns>
