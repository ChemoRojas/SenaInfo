...
public partial class mod_reportes_Rep_Diag_Ninos_DIAG_SOCIAL : System.Web.UI.UserControl
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        dt.Columns[10].ColumnName = "COD. SOCIAL";	//10
        dt.Columns[11].ColumnName = "COD. DIAGNOSTICO";	            //11
        dt.Columns[12].ColumnName = "FECHA DIAGNOSTICO";	//12
        dt.Columns[13].ColumnName = "SITUACION ESPECIAL";	//13
        dt.Columns[14].ColumnName = "SITUACION CALLE";	//14
        dt.Columns[15].ColumnName = "ESTADO ABANDONO";	//15
        dt.Columns[16].ColumnName = "SITUACION TUICION";	//16
        dt.Columns[17].ColumnName = "TECNICO";		    //17
        dt.Columns[18].ColumnName = "FECHA ACTUALIZACION";		    //18
