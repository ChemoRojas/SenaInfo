                ...
                <div>
                    ...
                    <div class="container theme-showcase" role="main">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Reportes de plan de intervención</li>
                        </ol>
                        ...
                        <div class="well">
                            <h4 class="subtitulo-form">Reportes de plan de Intervención</h4>
                            <hr />
                            <div class="row">
                                <div class="col-md-9">
                                    <table class="table table-borderless table-condensed table-col-fix">
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <th>
                                                    <label for="">
                                                        Código Plan de Intervención :</label>
                                                </th>
                                                <td >
                                                    <div class="col-md-7">
                                                    ...
                                                    <div class="col-md-5 no-padding">
                                                        <asp:TextBox ID="cPII" runat="server" AutoPostBack="True" CssClass="pull-right form-control input-sm" placeholder="Ingrese Código" ONVALUECHANGE="cPII_ValueChange" />
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:RadioButtonList align="center" ID="RadioButtonList2" RepeatDirection="Horizontal" runat="server" AutoPostBack="True">
                                                    <asp:ListItem Selected="True" Value="0">Eventos de Intervención</asp:ListItem>
                                                    <asp:ListItem Value="1">Areas de Intervención</asp:ListItem>
                                                    <asp:ListItem Value="2">Areas de Intervención Excel</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </td>
                                        </tr>
                                        <tr>
