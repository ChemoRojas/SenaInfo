<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_SituacionLegalInmueble.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Situaci&oacute;n Legal Inmueble </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodsituacionLegalInmueble" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodsituacionLegalInmueble" HeaderText="CodsituacionLegalInmueble"
                                    ReadOnly="True" SortExpression="CodsituacionLegalInmueble">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parSituacionLegalInmueble] WHERE [CodsituacionLegalInmueble] = @CodsituacionLegalInmueble"
                            InsertCommand="INSERT INTO [parSituacionLegalInmueble] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodsituacionLegalInmueble], [Descripcion], [IndVigencia] FROM [parSituacionLegalInmueble] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parSituacionLegalInmueble] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodsituacionLegalInmueble] = @CodsituacionLegalInmueble">
                            <DeleteParameters>
                                <asp:Parameter Name="CodsituacionLegalInmueble" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodsituacionLegalInmueble" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parSituacionLegalInmueble] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodsituacionLegalInmueble], [Descripcion], [IndVigencia] FROM [parSituacionLegalInmueble]"
                            UpdateCommand="UPDATE [parSituacionLegalInmueble] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodsituacionLegalInmueble] = @CodsituacionLegalInmueble">
                            <DeleteParameters>
                                <asp:Parameter Name="CodsituacionLegalInmueble" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parSituacionLegalInmueble] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parSituacionLegalInmueble AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parSituacionLegalInmueble] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodsituacionLegalInmueble] = @CodsituacionLegalInmueble">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
