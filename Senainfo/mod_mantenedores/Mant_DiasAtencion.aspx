<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_DiasAtencion.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de D&iacute;as Atenci&oacute;n </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodDiasAtencion" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodDiasAtencion" HeaderText="CodDiasAtencion" ReadOnly="True"
                                    SortExpression="CodDiasAtencion">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="CodNemotecnico" HeaderText="CodNemotecnico" SortExpression="CodNemotecnico">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Descripcion" HeaderText="Descripcion" SortExpression="Descripcion">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="DiasSemana" HeaderText="DiasSemana" SortExpression="DiasSemana">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                                <asp:CheckBoxField DataField="Feriado" HeaderText="Feriado" SortExpression="Feriado">
                                    <ItemStyle Font-Size="11px" />
                                </asp:CheckBoxField>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parDiasAtencion] WHERE [CodDiasAtencion] = @CodDiasAtencion"
                            InsertCommand="INSERT INTO [parDiasAtencion] ([CodNemotecnico], [Descripcion], [DiasSemana], [Feriado], [IndVigencia]) VALUES (@CodNemotecnico, @Descripcion, @DiasSemana, @Feriado, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodDiasAtencion], [CodNemotecnico], [Descripcion], [DiasSemana], [Feriado], [IndVigencia] FROM [parDiasAtencion] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parDiasAtencion] SET [CodNemotecnico] = @CodNemotecnico, [Descripcion] = @Descripcion, [DiasSemana] = @DiasSemana, [Feriado] = @Feriado, [IndVigencia] = @IndVigencia WHERE [CodDiasAtencion] = @CodDiasAtencion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodDiasAtencion" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                                <asp:Parameter Name="CodNemotecnico" Type="String" />
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="DiasSemana" Type="String" />
                                <asp:Parameter Name="Feriado" Type="Boolean" />
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodDiasAtencion" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parDiasAtencion] ([CodNemotecnico], [Descripcion], [DiasSemana], [Feriado], [IndVigencia]) VALUES (@CodNemotecnico, @Descripcion, @DiasSemana, @Feriado, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodDiasAtencion], [CodNemotecnico], [Descripcion], [DiasSemana], [Feriado], [IndVigencia] FROM [parDiasAtencion]"
                            UpdateCommand="UPDATE [parDiasAtencion] SET [CodNemotecnico] = @CodNemotecnico, [Descripcion] = @Descripcion, [DiasSemana] = @DiasSemana, [Feriado] = @Feriado, [IndVigencia] = @IndVigencia WHERE [CodDiasAtencion] = @CodDiasAtencion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodDiasAtencion" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parDiasAtencion] ([CodNemotecnico], [Descripcion], [DiasSemana], [Feriado], [IndVigencia]) VALUES (@CodNemotecnico, @Descripcion, @DiasSemana, @Feriado, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parDiasAtencion AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parDiasAtencion] SET [CodNemotecnico] = @CodNemotecnico, [Descripcion] = @Descripcion, [DiasSemana] = @DiasSemana, [Feriado] = @Feriado, [IndVigencia] = @IndVigencia WHERE [CodDiasAtencion] = @CodDiasAtencion">
                            <InsertParameters>
                                <asp:Parameter Name="CodNemotecnico" Type="String" />
                                <asp:Parameter Name="Descripcion" Type="String" />
                ...
                <tr>
                    <td>
                        <asp:Panel ID="Panel1" runat="server" Height="88px" Width="100%" Visible="False" Wrap="False">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="fondobordetabla" style="width: 578px">
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                            <tr>
                                                <td width="225" class="texto_form" style="width: 127px">Nemot&eacute;cnico</td>
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox2" runat="server" Width="100px" MaxLength="3" Font-Size="11px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="texto_form" style="width: 127px">Descripci&oacute;n</td>
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox3" runat="server" Width="650px" MaxLength="200" Font-Names="Arial" Font-Size="11px" TextMode="MultiLine"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="texto_form" style="width: 127px">D&iacute;as Semana</td>
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox4" runat="server" Width="100px" MaxLength="7" Font-Size="11px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="texto_form" style="width: 127px">Feriado</td>
                                                <td class="linea_inferior">
                                                    <asp:CheckBox ID="CheckBox1" runat="server" Font-Size="11px" /></td>
                                            </tr>
                                            <tr>
                                                <td class="texto_form" style="width: 127px">IndVigencia</td>
                                                <td class="linea_inferior">
