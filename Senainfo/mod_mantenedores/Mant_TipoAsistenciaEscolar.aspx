<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_TipoAsistenciaEscolar.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Asistencia Escolar </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoAsistenciaEscolar" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="TipoAsistenciaEscolar" HeaderText="TipoAsistenciaEscolar"
                                    ReadOnly="True" SortExpression="TipoAsistenciaEscolar">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTipoAsistenciaEscolar] WHERE [TipoAsistenciaEscolar] = @TipoAsistenciaEscolar"
                            InsertCommand="INSERT INTO [parTipoAsistenciaEscolar] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoAsistenciaEscolar], [Descripcion], [IndVigencia] FROM [parTipoAsistenciaEscolar] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parTipoAsistenciaEscolar] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoAsistenciaEscolar] = @TipoAsistenciaEscolar">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoAsistenciaEscolar" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoAsistenciaEscolar" DataSourceID="SqlDataSource2"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="IndVigencia">
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="DropDownList2" runat="server" SelectedValue='<%# Bind("IndVigencia") %>' DataSourceID="SqlDataSource3" DataTextField="Tabla_Descripcion" DataValueField="Tabla_Valor"></asp:DropDownList>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoAsistenciaEscolar] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoAsistenciaEscolar], [Descripcion], [IndVigencia] FROM [parTipoAsistenciaEscolar]"
                            UpdateCommand="UPDATE [parTipoAsistenciaEscolar] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoAsistenciaEscolar] = @TipoAsistenciaEscolar">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoAsistenciaEscolar" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoAsistenciaEscolar] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoAsistenciaEscolar AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoAsistenciaEscolar] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoAsistenciaEscolar] = @TipoAsistenciaEscolar">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoAsistenciaEscolar" Type="Int16" />
                            </DeleteParameters>
