<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_Diligencia.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Diligencia </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodDiligencia" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodDiligencia" HeaderText="CodDiligencia" ReadOnly="True"
                                    SortExpression="CodDiligencia">
                                ...
                                <asp:CheckBoxField DataField="PropuestaTecnica" HeaderText="PropuestaTecnica" SortExpression="PropuestaTecnica">
                                    <ItemStyle Font-Size="11px" />
                                </asp:CheckBoxField>
                                <asp:CheckBoxField DataField="ResultadoDiscernimiento" HeaderText="ResultadoDiscernimiento"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parDiligencia] WHERE [CodDiligencia] = @CodDiligencia"
                            InsertCommand="INSERT INTO [parDiligencia] ([Descripcion], [IndVigencia], [PropuestaTecnica], [ResultadoDiscernimiento]) VALUES (@Descripcion, @IndVigencia, @PropuestaTecnica, @ResultadoDiscernimiento)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodDiligencia], [Descripcion], [IndVigencia], [PropuestaTecnica], [ResultadoDiscernimiento] FROM [parDiligencia] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parDiligencia] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia, [PropuestaTecnica] = @PropuestaTecnica, [ResultadoDiscernimiento] = @ResultadoDiscernimiento WHERE [CodDiligencia] = @CodDiligencia">
                            <DeleteParameters>
                                <asp:Parameter Name="CodDiligencia" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                                <asp:Parameter Name="PropuestaTecnica" Type="Boolean" />
                                <asp:Parameter Name="ResultadoDiscernimiento" Type="Boolean" />
                                <asp:Parameter Name="CodDiligencia" Type="Int16" />
                            </UpdateParameters>
                            <SelectParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodDiligencia" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parDiligencia] ([Descripcion], [IndVigencia], [PropuestaTecnica], [ResultadoDiscernimiento]) VALUES (@Descripcion, @IndVigencia, @PropuestaTecnica, @ResultadoDiscernimiento)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodDiligencia], [Descripcion], [IndVigencia], [PropuestaTecnica], [ResultadoDiscernimiento] FROM [parDiligencia]"
                            UpdateCommand="UPDATE [parDiligencia] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia, [PropuestaTecnica] = @PropuestaTecnica, [ResultadoDiscernimiento] = @ResultadoDiscernimiento WHERE [CodDiligencia] = @CodDiligencia">
                            <DeleteParameters>
                                <asp:Parameter Name="CodDiligencia" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parDiligencia] ([Descripcion], [IndVigencia], [PropuestaTecnica], [ResultadoDiscernimiento]) VALUES (@Descripcion, @IndVigencia, @PropuestaTecnica, @ResultadoDiscernimiento)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parDiligencia AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parDiligencia] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia, [PropuestaTecnica] = @PropuestaTecnica, [ResultadoDiscernimiento] = @ResultadoDiscernimiento WHERE [CodDiligencia] = @CodDiligencia">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                                ...
                                <tr>
                                    <td class="fondobordetabla" style="width: 578px">
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                            <tr>
                                                <td width="225" class="texto_form" style="width: 127px">Descripci&oacute;n</td>
                                            ...
                                            <tr>
                                                <td class="texto_form" style="width: 127px">Propuesta T&eacute;cnica</td>
                                                <td class="linea_inferior">
                                                    <asp:CheckBox ID="CheckBox1" runat="server" Font-Size="11px" /></td>
                                            </tr>
                                            <tr>
                                                <td class="texto_form" style="width: 127px">Resultado Discernimiento</td>
                                                <td class="linea_inferior">
