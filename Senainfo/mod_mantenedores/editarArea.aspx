<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editarArea.aspx.cs" Inherits="mod_mantenedores_editarArea" %>
    ...
    <div>
         ...
         <div class="alert alert-warning text-center" role="alert" id="alertW" runat="server" visible="false">
                    ...
                    <div class="alert alert-success text-center" role="alert" id="alertS" runat="server" visible="false">
                        <span class="glyphicon glyphicon-ok"></span>Datos del Área registrados satisfactoriamente.
                                ...
                                <table class="table table-bordered  table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" class="col-md-8">
                                                ...
                                                <asp:TextBox ID="txtAreaEditar" runat="server" MaxLength="100" CssClass="form-control input-sm" placeholder="Ingrese nombre de área" ></asp:TextBox>
                                                <asp:TextBox ID="txtCodArea" runat="server" MaxLength="100" CssClass="form-control input-sm"  Visible="false" ></asp:TextBox>
