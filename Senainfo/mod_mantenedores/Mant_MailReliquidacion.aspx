<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_MailReliquidacion.aspx.cs" Inherits="Default3" %>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodMail" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodMail" HeaderText="CodMail" ReadOnly="True" SortExpression="CodMail">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parMailReliquidacion] WHERE [CodMail] = @CodMail"
                            InsertCommand="INSERT INTO [parMailReliquidacion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodMail], [Descripcion], [IndVigencia] FROM [parMailReliquidacion] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parMailReliquidacion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodMail] = @CodMail">
                            <DeleteParameters>
                                <asp:Parameter Name="CodMail" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodMail" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parMailReliquidacion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodMail], [Descripcion], [IndVigencia] FROM [parMailReliquidacion]"
                            UpdateCommand="UPDATE [parMailReliquidacion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodMail] = @CodMail">
                            <DeleteParameters>
                                <asp:Parameter Name="CodMail" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parMailReliquidacion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parMailReliquidacion AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parMailReliquidacion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodMail] = @CodMail">
                            <DeleteParameters>
                                <asp:Parameter Name="CodMail" Type="Int16" />
                            </DeleteParameters>
