<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_Localidad.aspx.cs" Inherits="Mant_Localidad" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Localidad </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodLocalidad" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodLocalidad" HeaderText="CodLocalidad" ReadOnly="True"
                                    SortExpression="CodLocalidad">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parLocalidad] WHERE [CodLocalidad] = @CodLocalidad"
                            InsertCommand="INSERT INTO [parLocalidad] ([CodProvincia], [Descripcion], [PorcentajeAsignacion], [PorcentajeAsignacionNL], [IndVigencia]) VALUES (@CodProvincia, @Descripcion, @PorcentajeAsignacion, @PorcentajeAsignacionNL, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodLocalidad], [CodProvincia], [Descripcion], [PorcentajeAsignacion], [PorcentajeAsignacionNL], [IndVigencia] FROM [parLocalidad] WHERE (([CodProvincia] = @CodProvincia) AND ([Descripcion] LIKE '%' + @Descripcion + '%'))"
                            UpdateCommand="UPDATE [parLocalidad] SET [CodProvincia] = @CodProvincia, [Descripcion] = @Descripcion, [PorcentajeAsignacion] = @PorcentajeAsignacion, [PorcentajeAsignacionNL] = @PorcentajeAsignacionNL, [IndVigencia] = @IndVigencia WHERE [CodLocalidad] = @CodLocalidad">
                            <DeleteParameters>
                                <asp:Parameter Name="CodLocalidad" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodLocalidad" DataSourceID="SqlDataSource2"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="CodProvincia">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox5" runat="server" Enabled="False" Text='<%# Bind("CodProvincia") %>'
                                            Width="40px"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parLocalidad] ([CodProvincia], [Descripcion], [PorcentajeAsignacion], [PorcentajeAsignacionNL], [IndVigencia]) VALUES (@CodProvincia, @Descripcion, @PorcentajeAsignacion, @PorcentajeAsignacionNL, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodLocalidad], [CodProvincia], [Descripcion], [PorcentajeAsignacion], [PorcentajeAsignacionNL], [IndVigencia] FROM [parLocalidad] WHERE ([CodProvincia] = @CodProvincia)"
                            UpdateCommand="UPDATE [parLocalidad] SET [CodProvincia] = @CodProvincia, [Descripcion] = @Descripcion, [PorcentajeAsignacion] = @PorcentajeAsignacion, [PorcentajeAsignacionNL] = @PorcentajeAsignacionNL, [IndVigencia] = @IndVigencia WHERE [CodLocalidad] = @CodLocalidad">
                            <DeleteParameters>
                                <asp:Parameter Name="CodLocalidad" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parLocalidad] ([CodProvincia], [Descripcion], [PorcentajeAsignacion], [PorcentajeAsignacionNL], [IndVigencia]) VALUES (@CodProvincia, @Descripcion, @PorcentajeAsignacion, @PorcentajeAsignacionNL, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parLocalidad AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parLocalidad] SET [CodProvincia] = @CodProvincia, [Descripcion] = @Descripcion, [PorcentajeAsignacion] = @PorcentajeAsignacion, [PorcentajeAsignacionNL] = @PorcentajeAsignacionNL, [IndVigencia] = @IndVigencia WHERE [CodLocalidad] = @CodLocalidad">
                            <DeleteParameters>
                                <asp:Parameter Name="CodLocalidad" Type="Int16" />
                            </DeleteParameters>
