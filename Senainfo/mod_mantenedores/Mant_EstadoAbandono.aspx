<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_EstadoAbandono.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Estado Abandono </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodEstadoAbandono" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodEstadoAbandono" HeaderText="CodEstadoAbandono" ReadOnly="True"
                                    SortExpression="CodEstadoAbandono">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            SelectCommand="SELECT [CodEstadoAbandono], [Descripcion], [Nemotecnico], [IndVigencia] FROM [parEstadoAbandono] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodEstadoAbandono" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parEstadoAbandono] ([Descripcion], [Nemotecnico], [IndVigencia]) VALUES (@Descripcion, @Nemotecnico, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodEstadoAbandono], [Descripcion], [Nemotecnico], [IndVigencia] FROM [parEstadoAbandono]"
                            UpdateCommand="UPDATE [parEstadoAbandono] SET [Descripcion] = @Descripcion, [Nemotecnico] = @Nemotecnico, [IndVigencia] = @IndVigencia WHERE [CodEstadoAbandono] = @CodEstadoAbandono">
                            <DeleteParameters>
                                <asp:Parameter Name="CodEstadoAbandono" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parEstadoAbandono] ([Descripcion], [Nemotecnico], [IndVigencia]) VALUES (@Descripcion, @Nemotecnico, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parEstadoAbandono AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parEstadoAbandono] SET [Descripcion] = @Descripcion, [Nemotecnico] = @Nemotecnico, [IndVigencia] = @IndVigencia WHERE [CodEstadoAbandono] = @CodEstadoAbandono">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="Nemotecnico" Type="String" />
                                    ...
                                    <td>
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox3" runat="server" Width="50px" MaxLength="1" Font-Size="11px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
