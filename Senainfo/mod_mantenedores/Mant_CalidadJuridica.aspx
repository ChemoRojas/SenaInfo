<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_CalidadJuridica.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Calidad Jur&iacute;dica </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodCalidadJuridica" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodCalidadJuridica" HeaderText="CodCalidadJuridica" ReadOnly="True"
                                    SortExpression="CodCalidadJuridica">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parCalidadJuridica] WHERE [CodCalidadJuridica] = @CodCalidadJuridica"
                            InsertCommand="INSERT INTO [parCalidadJuridica] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodCalidadJuridica], [Descripcion], [IndVigencia] FROM [parCalidadJuridica] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parCalidadJuridica] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCalidadJuridica] = @CodCalidadJuridica">
                            <DeleteParameters>
                                <asp:Parameter Name="CodCalidadJuridica" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodCalidadJuridica" DataSourceID="SqlDataSource2"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="IndVigencia" HeaderText="IndVigencia" SortExpression="IndVigencia" ReadOnly="True" Visible="False">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="IndVigencia">
                                    <EditItemTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parCalidadJuridica] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodCalidadJuridica], [Descripcion], [IndVigencia] FROM [parCalidadJuridica]"
                            UpdateCommand="UPDATE [parCalidadJuridica] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCalidadJuridica] = @CodCalidadJuridica">
                            <DeleteParameters>
                                <asp:Parameter Name="CodCalidadJuridica" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parCalidadJuridica] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parCalidadJuridica AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parCalidadJuridica] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCalidadJuridica] = @CodCalidadJuridica">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
