<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editarPreguntasModulo.aspx.cs" Inherits="mod_mantenedores_editarPreguntasModulo" %>
...
<head id="Head1" runat="server">
    ...
    <title>Editar Preguntas del Módulo :: Senainfo :: Servicio Nacional de Menores</title>
    ...
    <div>
         ...
         <div class="alert alert-warning text-center" role="alert" id="alertW" runat="server" visible="false">
                    ...
                    <div class="alert alert-success text-center" role="alert" id="alertS" runat="server" visible="false">
                        <span class="glyphicon glyphicon-ok"></span>Datos de la pregunta Modificados satisfactoriamente.
             ...
             <div class="well" id="grabar" visible="true" runat="server">
              ...
              <table class="table table-bordered  table-condensed">
                    ...
                    <asp:TextBox ID="txtCodPreguntaModulo" runat="server" MaxLength="100" CssClass="form-control input-sm"  Visible="false" ></asp:TextBox>    
