<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_ConQuienEgresa.aspx.cs" Inherits="Default4" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Con Qui&eacute;n Egresa </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodConQuienEgresa" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodConQuienEgresa" HeaderText="CodConQuienEgresa" ReadOnly="True"
                                    SortExpression="CodConQuienEgresa">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parConQuienEgresa] WHERE [CodConQuienEgresa] = @CodConQuienEgresa"
                            InsertCommand="INSERT INTO [parConQuienEgresa] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodConQuienEgresa], [Descripcion], [IndVigencia] FROM [parConQuienEgresa] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parConQuienEgresa] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodConQuienEgresa] = @CodConQuienEgresa">
                            <DeleteParameters>
                                <asp:Parameter Name="CodConQuienEgresa" Type="Int32" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodConQuienEgresa" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parConQuienEgresa] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodConQuienEgresa], [Descripcion], [IndVigencia] FROM [parConQuienEgresa]"
                            UpdateCommand="UPDATE [parConQuienEgresa] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodConQuienEgresa] = @CodConQuienEgresa">
                            <DeleteParameters>
                                <asp:Parameter Name="CodConQuienEgresa" Type="Int32" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parConQuienEgresa] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parConQuienEgresa AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parConQuienEgresa] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodConQuienEgresa] = @CodConQuienEgresa">
                            <DeleteParameters>
                                <asp:Parameter Name="CodConQuienEgresa" Type="Int32" />
                            </DeleteParameters>
