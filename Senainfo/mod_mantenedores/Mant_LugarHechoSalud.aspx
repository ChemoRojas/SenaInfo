<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_LugarHechoSalud.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Lugar de Hecho Salud </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodLugarHechoSalud" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodLugarHechoSalud" HeaderText="CodLugarHechoSalud" ReadOnly="True"
                                    SortExpression="CodLugarHechoSalud">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parLugarHechoSalud] WHERE [CodLugarHechoSalud] = @CodLugarHechoSalud"
                            InsertCommand="INSERT INTO [parLugarHechoSalud] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodLugarHechoSalud], [Descripcion], [IndVigencia] FROM [parLugarHechoSalud] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parLugarHechoSalud] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodLugarHechoSalud] = @CodLugarHechoSalud">
                            <DeleteParameters>
                                <asp:Parameter Name="CodLugarHechoSalud" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodLugarHechoSalud" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parLugarHechoSalud] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodLugarHechoSalud], [Descripcion], [IndVigencia] FROM [parLugarHechoSalud]"
                            UpdateCommand="UPDATE [parLugarHechoSalud] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodLugarHechoSalud] = @CodLugarHechoSalud">
                            <DeleteParameters>
                                <asp:Parameter Name="CodLugarHechoSalud" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parLugarHechoSalud] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parLugarHechoSalud AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parLugarHechoSalud] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodLugarHechoSalud] = @CodLugarHechoSalud">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
