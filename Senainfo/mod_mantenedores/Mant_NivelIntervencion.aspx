<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_NivelIntervencion.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Nivel Intervenci&oacute;n </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodNivelIntervencion" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodNivelIntervencion" HeaderText="CodNivelIntervencion"
                                    ReadOnly="True" SortExpression="CodNivelIntervencion">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parNivelIntervencion] WHERE [CodNivelIntervencion] = @CodNivelIntervencion"
                            InsertCommand="INSERT INTO [parNivelIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodNivelIntervencion], [Descripcion], [IndVigencia] FROM [parNivelIntervencion] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parNivelIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodNivelIntervencion] = @CodNivelIntervencion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodNivelIntervencion" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodNivelIntervencion" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parNivelIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodNivelIntervencion], [Descripcion], [IndVigencia] FROM [parNivelIntervencion]"
                            UpdateCommand="UPDATE [parNivelIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodNivelIntervencion] = @CodNivelIntervencion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodNivelIntervencion" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parNivelIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parNivelIntervencion AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parNivelIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodNivelIntervencion] = @CodNivelIntervencion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodNivelIntervencion" Type="Int16" />
                            </DeleteParameters>
