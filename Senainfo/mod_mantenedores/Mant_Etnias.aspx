<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_Etnias.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Etnias </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodEtnia" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodEtnia" HeaderText="CodEtnia" ReadOnly="True" SortExpression="CodEtnia">
                                ...
                                <asp:TemplateField HeaderText="IndVigencia">
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="DropDownList1" runat="server" SelectedValue='<%# Bind("IndVigencia") %>' DataSourceID="SqlDataSource3" DataTextField="Tabla_Descripcion" DataValueField="Tabla_Valor"></asp:DropDownList>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parEtnias] WHERE [CodEtnia] = @CodEtnia" InsertCommand="INSERT INTO [parEtnias] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodEtnia], [Descripcion], [IndVigencia] FROM [parEtnias] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parEtnias] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodEtnia] = @CodEtnia">
                            <DeleteParameters>
                                <asp:Parameter Name="CodEtnia" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodEtnia" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parEtnias] WHERE [CodEtnia] = @CodEtnia" InsertCommand="INSERT INTO [parEtnias] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodEtnia], [Descripcion], [IndVigencia] FROM [parEtnias]"
                            UpdateCommand="UPDATE [parEtnias] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodEtnia] = @CodEtnia">
                            <DeleteParameters>
                                <asp:Parameter Name="CodEtnia" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parEtnias] WHERE [CodEtnia] = @CodEtnia" InsertCommand="INSERT INTO [parEtnias] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parEtnias AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')
"
                            UpdateCommand="UPDATE [parEtnias] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodEtnia] = @CodEtnia">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
