<%@ Page Language="C#" Culture="es-CL" UICulture="es" AutoEventWireup="true" CodeFile="Mant_TipoSubvencion.aspx.cs" Inherits="Mant_TipoSubvencion" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Subvención </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                        <tr>
                                            <td width="225" class="texto_form">Tipo Proyecto</td>
                                            <td class="linea_inferior">
                                                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource4" DataTextField="Descripcion" DataValueField="TipoProyecto" AutoPostBack="True" Font-Size="11px" Width="350px"></asp:DropDownList></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoSubvencion" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="TipoSubvencion" HeaderText="TipoSubvencion" ReadOnly="True"
                                    SortExpression="TipoSubvencion">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTipoSubvencion] WHERE [TipoSubvencion] = @TipoSubvencion"
                            InsertCommand="INSERT INTO [parTipoSubvencion] ([TipoProyecto], [Descripcion], [IndVigencia]) VALUES (@TipoProyecto, @Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoSubvencion], [TipoProyecto], [Descripcion], [IndVigencia] FROM [parTipoSubvencion] WHERE (([TipoProyecto] = @TipoProyecto) AND ([Descripcion] LIKE '%' + @Descripcion + '%'))"
                            UpdateCommand="UPDATE [parTipoSubvencion] SET [TipoProyecto] = @TipoProyecto, [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoSubvencion] = @TipoSubvencion">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoSubvencion" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                            ...
                            <SelectParameters>
                                <asp:ControlParameter ControlID="DropDownList1" Name="TipoProyecto" PropertyName="SelectedValue"
                                    Type="Int16" />
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoSubvencion" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoSubvencion] ([TipoProyecto], [Descripcion], [IndVigencia]) VALUES (@TipoProyecto, @Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoSubvencion], [TipoProyecto], [Descripcion], [IndVigencia] FROM [parTipoSubvencion] WHERE ([TipoProyecto] = @TipoProyecto)"
                            UpdateCommand="UPDATE [parTipoSubvencion] SET [TipoProyecto] = @TipoProyecto, [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoSubvencion] = @TipoSubvencion">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoSubvencion" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoSubvencion] ([TipoProyecto], [Descripcion], [IndVigencia]) VALUES (@TipoProyecto, @Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoSubvencion AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoSubvencion] SET [TipoProyecto] = @TipoProyecto, [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoSubvencion] = @TipoSubvencion">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoSubvencion" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoProyecto] ([TipoProyecto], [Descripcion]) VALUES (@TipoProyecto, @Descripcion)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoProyecto], [Descripcion] FROM [parTipoProyecto]" UpdateCommand="UPDATE [parTipoProyecto] SET [Descripcion] = @Descripcion WHERE [TipoProyecto] = @TipoProyecto">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoProyecto" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
