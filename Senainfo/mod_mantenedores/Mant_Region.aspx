<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_Region.aspx.cs" Inherits="Mant_Region" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Región </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodRegion" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodRegion" HeaderText="CodRegion" ReadOnly="True" SortExpression="CodRegion">
                                ...
                                <asp:TemplateField HeaderText="TipoFlujo">
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource4"
                                            DataTextField="Tabla_Descripcion" DataValueField="Tabla_Valor" SelectedValue='<%# Bind("TipoFlujo") %>'>
                                        </asp:DropDownList>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("TipoFlujo") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Font-Size="11px" />
                                </asp:TemplateField>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            SelectCommand="SELECT [CodRegion], [Descripcion], [PorcentajeAsignacionNL], [IndVigencia], [TipoFlujo] FROM [parRegion] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodRegion" DataSourceID="SqlDataSource2"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="TipoFlujo">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("TipoFlujo") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Font-Size="11px" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="IndVigencia">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parRegion] WHERE [CodRegion] = @CodRegion" InsertCommand="INSERT INTO [parRegion] ([Descripcion], [PorcentajeAsignacionNL], [IndVigencia], [TipoFlujo]) VALUES (@Descripcion, @PorcentajeAsignacionNL, @IndVigencia, @TipoFlujo)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parRegion AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parRegion] SET [Descripcion] = @Descripcion, [PorcentajeAsignacionNL] = @PorcentajeAsignacionNL, [IndVigencia] = @IndVigencia, [TipoFlujo] = @TipoFlujo WHERE [CodRegion] = @CodRegion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodRegion" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parRegion] WHERE [CodRegion] = @CodRegion" InsertCommand="INSERT INTO [parRegion] ([Descripcion], [PorcentajeAsignacionNL], [IndVigencia], [TipoFlujo]) VALUES (@Descripcion, @PorcentajeAsignacionNL, @IndVigencia, @TipoFlujo)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parDominios AS pD WHERE (pD.IdTabla = 'TIPOFLUJO')"
                            UpdateCommand="UPDATE [parRegion] SET [Descripcion] = @Descripcion, [PorcentajeAsignacionNL] = @PorcentajeAsignacionNL, [IndVigencia] = @IndVigencia, [TipoFlujo] = @TipoFlujo WHERE [CodRegion] = @CodRegion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodRegion" Type="Int16" />
                            </DeleteParameters>
                                    ...
                                    <td>
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox3" runat="server" Width="50px" MaxLength="3" Font-Size="11px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="texto_form">Tipo Flujo</td>
                                                <td class="linea_inferior">
                                                    <asp:DropDownList ID="DropDownList6" runat="server" DataSourceID="SqlDataSource4"
                                                        DataTextField="Tabla_Descripcion" DataValueField="Tabla_Valor" Font-Size="11px" Width="350px">
                                                    </asp:DropDownList></td>
                                            </tr>
                                            <tr>
