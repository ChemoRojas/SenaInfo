<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_TipoInmueble.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Inmueble </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoInmueble" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                <asp:CommandField ShowEditButton="True" CancelText="Cancelar" DeleteText="Borrar" EditText="Modificar" InsertText="Insertar" NewText="Nuevo" SelectText="Seleccionar" UpdateText="Actualizar">
                                    <ItemStyle Font-Bold="False" Font-Size="11px" ForeColor="Red" />
                                </asp:CommandField>
                                <asp:BoundField DataField="TipoInmueble" HeaderText="TipoInmueble" ReadOnly="True"
                                    SortExpression="TipoInmueble">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTipoInmueble] WHERE [TipoInmueble] = @TipoInmueble"
                            InsertCommand="INSERT INTO [parTipoInmueble] ([Descripcion], [Indvigencia]) VALUES (@Descripcion, @Indvigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoInmueble], [Descripcion], [Indvigencia] FROM [parTipoInmueble] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parTipoInmueble] SET [Descripcion] = @Descripcion, [Indvigencia] = @Indvigencia WHERE [TipoInmueble] = @TipoInmueble">
                            <InsertParameters>
                            ...
                            <UpdateParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="Indvigencia" Type="String" />
                                <asp:Parameter Name="TipoInmueble" Type="Int16" />
                            </UpdateParameters>
                            <DeleteParameters>
                                <asp:Parameter Name="TipoInmueble" Type="Int16" />
                            </DeleteParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoInmueble" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoInmueble] ([Descripcion], [Indvigencia]) VALUES (@Descripcion, @Indvigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoInmueble], [Descripcion], [Indvigencia] FROM [parTipoInmueble]"
                            UpdateCommand="UPDATE [parTipoInmueble] SET [Descripcion] = @Descripcion, [Indvigencia] = @Indvigencia WHERE [TipoInmueble] = @TipoInmueble">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="Indvigencia" Type="String" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoInmueble] ([Descripcion], [Indvigencia]) VALUES (@Descripcion, @Indvigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoInmueble AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoInmueble] SET [Descripcion] = @Descripcion, [Indvigencia] = @Indvigencia WHERE [TipoInmueble] = @TipoInmueble">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="Indvigencia" Type="String" />
