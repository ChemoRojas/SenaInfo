<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_Documentos.aspx.cs" Inherits="mod_mantenedores_Mant_Documentos" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container theme-showcase" role="main">
            ...
            <div class="well">
                ...
                <h4 class="subtitulo-form">Mantenedor: Biblioteca de Documentos</h4>
                <hr>
                <table class="table table-borderless table-condensed table-col-fix">
                    <tr>
                        <td>
                                
                            <asp:LinkButton ID="btnNuevoDoc" runat="server" CssClass="btn btn-info btn-sm" OnClick="btnNuevoDoc_Click">
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:GridView ID="grdDocumentos" runat="server" AutoGenerateColumns="False" CellPadding="4" GridLines="None"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Usuario" HeaderText="Usuario modif." />
                                <asp:BoundField DataField="FechaModificacion" HeaderText="Fecha última modif." DataFormatString="{0:d}" />
                                <asp:hyperlinkfield text='<span class="glyphicon glyphicon-pencil"></span>' datanavigateurlfields="id" datanavigateurlformatstring="Mant_editDocumento.aspx?Id={0}" HeaderText="Editar" ItemStyle-HorizontalAlign="Center" />
