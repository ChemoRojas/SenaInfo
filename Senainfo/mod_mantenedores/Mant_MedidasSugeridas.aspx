<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_MedidasSugeridas.aspx.cs" Inherits="Default3" %>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodMedidasSugeridas" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodMedidasSugeridas" HeaderText="CodMedidasSugeridas"
                                    ReadOnly="True" SortExpression="CodMedidasSugeridas">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parMedidasSugeridas] WHERE [CodMedidasSugeridas] = @CodMedidasSugeridas"
                            InsertCommand="INSERT INTO [parMedidasSugeridas] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodMedidasSugeridas], [Descripcion], [IndVigencia] FROM [parMedidasSugeridas] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parMedidasSugeridas] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodMedidasSugeridas] = @CodMedidasSugeridas">
                            <InsertParameters>
                            ...
                            <UpdateParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                                <asp:Parameter Name="CodMedidasSugeridas" Type="Int16" />
                            </UpdateParameters>
                            <DeleteParameters>
                                <asp:Parameter Name="CodMedidasSugeridas" Type="Int16" />
                            </DeleteParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodMedidasSugeridas" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parMedidasSugeridas] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodMedidasSugeridas], [Descripcion], [IndVigencia] FROM [parMedidasSugeridas]"
                            UpdateCommand="UPDATE [parMedidasSugeridas] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodMedidasSugeridas] = @CodMedidasSugeridas">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parMedidasSugeridas] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parMedidasSugeridas AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parMedidasSugeridas] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodMedidasSugeridas] = @CodMedidasSugeridas">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
