<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_EstadoCapacitacion.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Estado Capacitaci&oacute;n </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodEstadoCapacitacion" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodEstadoCapacitacion" HeaderText="CodEstadoCapacitacion"
                                    ReadOnly="True" SortExpression="CodEstadoCapacitacion">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parEstadoCapacitacion] WHERE [CodEstadoCapacitacion] = @CodEstadoCapacitacion"
                            InsertCommand="INSERT INTO [parEstadoCapacitacion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodEstadoCapacitacion], [Descripcion], [IndVigencia] FROM [parEstadoCapacitacion] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parEstadoCapacitacion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodEstadoCapacitacion] = @CodEstadoCapacitacion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodEstadoCapacitacion" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodEstadoCapacitacion" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parEstadoCapacitacion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodEstadoCapacitacion], [Descripcion], [IndVigencia] FROM [parEstadoCapacitacion]"
                            UpdateCommand="UPDATE [parEstadoCapacitacion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodEstadoCapacitacion] = @CodEstadoCapacitacion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodEstadoCapacitacion" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parEstadoCapacitacion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parEstadoCapacitacion AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parEstadoCapacitacion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodEstadoCapacitacion] = @CodEstadoCapacitacion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodEstadoCapacitacion" Type="Int16" />
                            </DeleteParameters>
