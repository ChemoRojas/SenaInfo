<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_SituacionSocioEconomica.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Situaci&oacute;n Socio Econ&oacute;mica </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodSituacionSocioEconomica" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodSituacionSocioEconomica" HeaderText="CodSituacionSocioEconomica"
                                    ReadOnly="True" SortExpression="CodSituacionSocioEconomica">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Descripcion" HeaderText="Descripcion" SortExpression="Descripcion">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="IndVigencia" HeaderText="IndVigencia" SortExpression="IndVigencia" ReadOnly="True">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                    ...
                    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource3"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parSituacionSocioEconomica] WHERE [CodSituacionSocioEconomica] = @CodSituacionSocioEconomica"
                            InsertCommand="INSERT INTO [parSituacionSocioEconomica] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodSituacionSocioEconomica], [Descripcion], [IndVigencia] FROM [parSituacionSocioEconomica] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parSituacionSocioEconomica] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodSituacionSocioEconomica] = @CodSituacionSocioEconomica">
                            <DeleteParameters>
                                <asp:Parameter Name="CodSituacionSocioEconomica" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodSituacionSocioEconomica" DataSourceID="SqlDataSource2"
                            EmptyDataText="There are no data records to display." CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%">
                            <Columns>
                                <asp:CommandField ShowEditButton="True" CancelText="Cancelar" DeleteText="Borrar" EditText="Modificar" InsertText="Insertar" NewText="Nuevo" SelectText="Seleccionar" UpdateText="Actualizar">
                                    <ItemStyle Font-Size="11px" ForeColor="Red" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parSituacionSocioEconomica] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodSituacionSocioEconomica], [Descripcion], [IndVigencia] FROM [parSituacionSocioEconomica]"
                            UpdateCommand="UPDATE [parSituacionSocioEconomica] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodSituacionSocioEconomica] = @CodSituacionSocioEconomica">
                            <DeleteParameters>
                                <asp:Parameter Name="CodSituacionSocioEconomica" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parSituacionSocioEconomica] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parSituacionSocioEconomica AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parSituacionSocioEconomica] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodSituacionSocioEconomica] = @CodSituacionSocioEconomica">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
