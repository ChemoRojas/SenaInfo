<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_Objetivos.aspx.cs" Inherits="mod_mantenedores_Mant_Objetivos" %>
...
<head id="Head1" runat="server">
    ...
    <title>Mantenedor de Objetivos :: Senainfo :: Servicio Nacional de Menores</title>
    ...
    <script type="text/javascript">
        ...
        function limpiarForm() {
            window.location = "Mant_Objetivos.aspx"
        }
    </script>
</head>
            ...
            <ContentTemplate>
                ...
                <div class="container theme-showcase" role="main">
                    ...
                    <div class="alert alert-success text-center" role="alert" id="alertS" runat="server" visible="false">
                        <span class="glyphicon glyphicon-ok"></span>Datos del Objetivo registrados satisfactoriamente.
                          ...
                          <div class="row" visible="true" id="buscar" runat="server">
                                  <div class="col-md-9">
                                      <form action="">
                                          <table class="table table-borderless table-condensed table-col-fix">
                                              <tr>
                                                  <th class="col-md-3">
                                                      <label for="">Código de Objetivo:</label>
                                                  </th>
                                                  <td>
                                                      <div class="input-group">
                                                          <asp:TextBox ID="txtCodObjetivo" runat="server" CssClass="form-control input-sm" onkeypress="return numbersonly(event);"></asp:TextBox>
                                                      </div>
                                ...
                                <asp:Panel ID="panelInfoBusqueda" runat="server" CssClass="panel-info panel-primary-info">
                                    ...
                                    <div class="panel-footer">
                                        <asp:Label ID="Lbl_Info1" CssClass="subtitulo-form-info" runat="server" Text="Ingrese código de Objetivo." ></asp:Label><br />
                                        ...
                                        <asp:Panel ID="lbl002panel" runat="server" Visible="false" CssClass="text-center">
                                            ...
                                            <asp:Label ID="lbl002" runat="server">0</asp:Label></label></h4>
                                                    ...
                                                    <asp:GridView ID="grdBusqueda" runat="server" AutoGenerateColumns="False" CellPadding="4" GridLines="None" CssClass="table table table-bordered table-hover">
                                                        ...
                                                        <Columns>
                                                            <asp:BoundField DataField="CodObjetivo" HeaderText="Código de Objetivo" />
                                                            <asp:BoundField DataField="NombreObjetivo" HeaderText="Nombre del Objetivo" />
                                                            <asp:BoundField DataField="NombreArea" HeaderText="Área" />
                                                            <asp:BoundField DataField="RangoArea" HeaderText="Rango de Área" />
                                                            <asp:BoundField DataField="Vigencia" HeaderText="Vigencia" />
                                                            <asp:BoundField DataField="CodObjetivo" HtmlEncode="False" DataFormatString="<a href='editarObjetivo.aspx?CodObjetivo={0}'>Editar</a>" HeaderText="Editar" ItemStyle-HorizontalAlign="Center" />
                                                            <asp:BoundField DataField="CodObjetivo" HtmlEncode="False" DataFormatString="<a href='Mant_Objetivos.aspx?CodObjetivo={0}'>Cambiar Vigencia</a>" HeaderText="Cambiar Vigencia" ItemStyle-HorizontalAlign="Center" />
                                                        </Columns>
                        ...
                        <h4 class="subtitulo-form">Objetivos</h4>
                                ...
                                <table class="table table-bordered  table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <th class="titulo-tabla" scope="row">Nombre del Objetivo *</th>
                                        <td colspan="3" class="col-md-8">
                                            
                                                <asp:TextBox ID="txtObjetivo" runat="server" MaxLength="100" CssClass="form-control input-sm" placeholder="Ingrese nombre de objetivo" ></asp:TextBox>
                                    ...
                                    <tr>
                                                ...
                                                <th class="titulo-tabla" scope="row">Área *</th>
                                        <td colspan="3" class="col-md-8">
                                                <asp:DropDownList ID="ddownArea" runat="server" CssClass="form-control input-sm">
                                              ...
                                              <tr>
                                                ...
                                                <th class="titulo-tabla" scope="row">Rango Área *</th>
                                            <td colspan="3" class="col-md-8">
