<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_TipoEventoIntervencion.aspx.cs" Inherits="Mant_TipoEventoIntervencion" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Evento Intervención </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoEventoIntervencion" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="TipoEventoIntervencion" HeaderText="TipoEventoIntervencion"
                                    ReadOnly="True" SortExpression="TipoEventoIntervencion">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTipoEventoIntervencion] WHERE [TipoEventoIntervencion] = @TipoEventoIntervencion"
                            InsertCommand="INSERT INTO [parTipoEventoIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoEventoIntervencion], [Descripcion], [IndVigencia] FROM [parTipoEventoIntervencion] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parTipoEventoIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoEventoIntervencion] = @TipoEventoIntervencion">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoEventoIntervencion" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoEventoIntervencion" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoEventoIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoEventoIntervencion], [Descripcion], [IndVigencia] FROM [parTipoEventoIntervencion]"
                            UpdateCommand="UPDATE [parTipoEventoIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoEventoIntervencion] = @TipoEventoIntervencion">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoEventoIntervencion" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoEventoIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoEventoIntervencion AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoEventoIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoEventoIntervencion] = @TipoEventoIntervencion">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoEventoIntervencion" Type="Int16" />
                            </DeleteParameters>
