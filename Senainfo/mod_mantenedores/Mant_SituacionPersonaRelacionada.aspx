<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_SituacionPersonaRelacionada.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Situaci&oacute;n Persona Relacionada </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodSituacion" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodSituacion" HeaderText="CodSituacion" ReadOnly="True"
                                    SortExpression="CodSituacion">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parSituacionPersonaRelacionada] WHERE [CodSituacion] = @CodSituacion"
                            InsertCommand="INSERT INTO [parSituacionPersonaRelacionada] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodSituacion], [Descripcion], [IndVigencia] FROM [parSituacionPersonaRelacionada] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parSituacionPersonaRelacionada] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodSituacion] = @CodSituacion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodSituacion" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodSituacion" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parSituacionPersonaRelacionada] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodSituacion], [Descripcion], [IndVigencia] FROM [parSituacionPersonaRelacionada]"
                            UpdateCommand="UPDATE [parSituacionPersonaRelacionada] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodSituacion] = @CodSituacion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodSituacion" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parSituacionPersonaRelacionada] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parSituacionPersonaRelacionada AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parSituacionPersonaRelacionada] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodSituacion] = @CodSituacion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodSituacion" Type="Int16" />
                            </DeleteParameters>
