<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editarObjetivo.aspx.cs" Inherits="mod_mantenedores_editarObjetivo" %>
    ...
    <div>
         ...
         <div class="alert alert-warning text-center" role="alert" id="alertW" runat="server" visible="false">
                    ...
                    <div class="alert alert-success text-center" role="alert" id="alertS" runat="server" visible="false">
                        <span class="glyphicon glyphicon-ok"></span>Datos del Área Modificados satisfactoriamente.
             ...
             <div class="well" id="grabar" visible="true" runat="server">
                        <h4 class="subtitulo-form">Áreas</h4>
                                ...
                                <table class="table table-bordered  table-condensed">
                                    ...
                                    <asp:TextBox ID="txtCodObjetivo" runat="server" MaxLength="100" CssClass="form-control input-sm"  Visible="false" ></asp:TextBox>
