<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_Provincia.aspx.cs" Inherits="Mant_Provincia" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Provincia </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodProvincia" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodProvincia" HeaderText="CodProvincia" ReadOnly="True"
                                    SortExpression="CodProvincia">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            SelectCommand="SELECT [CodProvincia], [CodRegion], [Descripcion], [PorcentajeAsignacion], [PorcentajeAsignacionNL], [IndVigencia] FROM [parProvincia] WHERE (([CodRegion] = @CodRegion) AND ([Descripcion] LIKE '%' + @Descripcion + '%'))"
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodProvincia" DataSourceID="SqlDataSource2"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="CodRegion">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox5" runat="server" Enabled="False" Text='<%# Bind("CodRegion") %>'
                                            Width="40px"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parProvincia] ([CodRegion], [Descripcion], [PorcentajeAsignacion], [PorcentajeAsignacionNL], [IndVigencia]) VALUES (@CodRegion, @Descripcion, @PorcentajeAsignacion, @PorcentajeAsignacionNL, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodProvincia], [CodRegion], [Descripcion], [PorcentajeAsignacion], [PorcentajeAsignacionNL], [IndVigencia] FROM [parProvincia] WHERE ([CodRegion] = @CodRegion)"
                            UpdateCommand="UPDATE [parProvincia] SET [CodRegion] = @CodRegion, [Descripcion] = @Descripcion, [PorcentajeAsignacion] = @PorcentajeAsignacion, [PorcentajeAsignacionNL] = @PorcentajeAsignacionNL, [IndVigencia] = @IndVigencia WHERE [CodProvincia] = @CodProvincia">
                            <DeleteParameters>
                                <asp:Parameter Name="CodProvincia" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parProvincia] ([CodRegion], [Descripcion], [PorcentajeAsignacion], [PorcentajeAsignacionNL], [IndVigencia]) VALUES (@CodRegion, @Descripcion, @PorcentajeAsignacion, @PorcentajeAsignacionNL, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parProvincia AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parProvincia] SET [CodRegion] = @CodRegion, [Descripcion] = @Descripcion, [PorcentajeAsignacion] = @PorcentajeAsignacion, [PorcentajeAsignacionNL] = @PorcentajeAsignacionNL, [IndVigencia] = @IndVigencia WHERE [CodProvincia] = @CodProvincia">
                            <DeleteParameters>
                                <asp:Parameter Name="CodProvincia" Type="Int16" />
                            </DeleteParameters>
                                    ...
                                    <td>
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox4" runat="server" Width="50px" MaxLength="3" Font-Size="11px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
