<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_PreguntasModulo.aspx.cs" Inherits="mod_mantenedores_Mant_PreguntasModulo" %>
...
<head id="Head1" runat="server">
    ...
    <title>Mantenedor de Preguntas para el Módulo :: Senainfo :: Servicio Nacional de Menores</title>
    ...
    <script type="text/javascript">
        ...
        function limpiarForm() {
            window.location = "Mant_PreguntasModulo.aspx"
        }
    </script>
</head>
            ...
            <ContentTemplate>
                ...
                <div class="container theme-showcase" role="main">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Preguntas del Módulo</li>
                    </ol>
                    <div class="alert alert-warning text-center" role="alert" id="alertW" runat="server" visible="false">
                     ...
                     <div class="alert alert-warning text-center" role="alert" id="AlertNumero" runat="server" visible="false">
                        <span class="glyphicon glyphicon-warning-sign"></span>Solo pueden haber 5 preguntas activas por Modulo
                        <asp:Label ID="Label2" runat="server" Text="Faltan datos obligatorios para realizar el registro." Visible="false"></asp:Label>
                    </div>

                    <div class="alert alert-success text-center" role="alert" id="alertS" runat="server" visible="false">
                        <span class="glyphicon glyphicon-ok"></span>Datos de la Pregunta registrados satisfactoriamente.
                                              ...
                                              <tr>
                                                  ...
                                                  <td>
                                                      <div class="input-group">
                                                          <asp:TextBox ID="txtCodPregunta" CssClass="form-control input-sm" runat="server" onkeypress="return numbersonly(event);"></asp:TextBox>
                                                      </div>
                                        ...
                                        <asp:Panel ID="lbl002panel" runat="server" Visible="false" CssClass="text-center">
                                            ...
                                            <asp:Label ID="lbl002" runat="server">0</asp:Label></label></h4>
                                                    ...
                                                    <asp:GridView ID="grdBusqueda" runat="server" AutoGenerateColumns="False" CellPadding="4" GridLines="None" CssClass="table table table-bordered table-hover">
                                                        ...
                                                        <Columns>
                                                            <asp:BoundField DataField="CodPreguntaModulo" HeaderText="Código Pregunta" />
                                                            <asp:BoundField DataField="TextoPregunta" HeaderText="Pregunta" />
                                                            <asp:BoundField DataField="NombreModulo" HeaderText="Módulo" />
                                                            <asp:BoundField DataField="Vigencia" HeaderText="Vigencia" />
                                                            <asp:BoundField DataField="CodPreguntaModulo" HtmlEncode="False" DataFormatString="<a href='editarPreguntasModulo.aspx?CodPreguntaModulo={0}'>Editar</a>" HeaderText="Editar" ItemStyle-HorizontalAlign="Center" />
                                                            <asp:hyperlinkfield text="Cambiar Vigencia" datanavigateurlfields="CodPreguntaModulo,CodModulo" datanavigateurlformatstring="Mant_PreguntasModulo.aspx?CodPreguntaModulo={0}&amp;CodModulo={1}" HeaderText="Seleccionar" ItemStyle-HorizontalAlign="Center" />
                                                        </Columns>
                                ...
                                <table class="table table-bordered  table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" class="col-md-8">
                                                ...
                                                <asp:TextBox ID="txtPregunta" runat="server" MaxLength="100" CssClass="form-control input-sm" placeholder="Ingrese texto de la pregunta" ></asp:TextBox>
