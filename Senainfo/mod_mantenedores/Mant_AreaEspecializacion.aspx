<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_AreaEspecializacion.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Area Especializaci&oacute;n </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodAreaEspecializacion" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodAreaEspecializacion" HeaderText="CodAreaEspecializacion"
                                    ReadOnly="True" SortExpression="CodAreaEspecializacion">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parAreaEspecializacion] WHERE [CodAreaEspecializacion] = @CodAreaEspecializacion"
                            InsertCommand="INSERT INTO [parAreaEspecializacion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodAreaEspecializacion], [Descripcion], [IndVigencia] FROM [parAreaEspecializacion] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parAreaEspecializacion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodAreaEspecializacion] = @CodAreaEspecializacion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodAreaEspecializacion" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodAreaEspecializacion" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parAreaEspecializacion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodAreaEspecializacion], [Descripcion], [IndVigencia] FROM [parAreaEspecializacion]"
                            UpdateCommand="UPDATE [parAreaEspecializacion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodAreaEspecializacion] = @CodAreaEspecializacion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodAreaEspecializacion" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parAreaEspecializacion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parAreaEspecializacion AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parAreaEspecializacion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodAreaEspecializacion] = @CodAreaEspecializacion">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                    ...
                    <td>
                        <asp:Panel ID="Panel1" runat="server" Width="100%" Visible="False" Wrap="False">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td>
                                        <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Images/Botones/guardar2.gif" OnClick="ImageButton2_Click1" />
                                        &nbsp; &nbsp; &nbsp;&nbsp;
                        <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/Images/Botones/Cancelar2.gif" OnClick="ImageButton3_Click" /></td>
                                </tr>
                            </table>
                        </asp:Panel>
                    </td>
