<%@ Page Language="C#" Culture="es-CL" UICulture="es" AutoEventWireup="true" CodeFile="Mant_TipoRelacionConQuienVive.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Intervenci&oacute;n Relaci&oacute;n Con Qui&eacute;n Vive </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodTipoRelacionConQuienVive" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodTipoRelacionConQuienVive" HeaderText="CodTipoRelacionConQuienVive"
                                    ReadOnly="True" SortExpression="CodTipoRelacionConQuienVive">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTipoRelacionConQuienVive] WHERE [CodTipoRelacionConQuienVive] = @CodTipoRelacionConQuienVive"
                            InsertCommand="INSERT INTO [parTipoRelacionConQuienVive] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodTipoRelacionConQuienVive], [Descripcion], [IndVigencia] FROM [parTipoRelacionConQuienVive] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parTipoRelacionConQuienVive] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodTipoRelacionConQuienVive] = @CodTipoRelacionConQuienVive">
                            <DeleteParameters>
                                <asp:Parameter Name="CodTipoRelacionConQuienVive" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodTipoRelacionConQuienVive" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoRelacionConQuienVive] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodTipoRelacionConQuienVive], [Descripcion], [IndVigencia] FROM [parTipoRelacionConQuienVive]"
                            UpdateCommand="UPDATE [parTipoRelacionConQuienVive] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodTipoRelacionConQuienVive] = @CodTipoRelacionConQuienVive">
                            <DeleteParameters>
                                <asp:Parameter Name="CodTipoRelacionConQuienVive" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoRelacionConQuienVive] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoRelacionConQuienVive AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoRelacionConQuienVive] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodTipoRelacionConQuienVive] = @CodTipoRelacionConQuienVive">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
