<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_CorteApelaciones.aspx.cs" Inherits="Mant_CorteApelaciones" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Corte de Apelaciones </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodCorteApelacion" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodCorteApelacion" HeaderText="CodCorteApelacion" ReadOnly="True"
                                    SortExpression="CodCorteApelacion">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parCorteApelaciones] WHERE [CodCorteApelacion] = @CodCorteApelacion"
                            InsertCommand="INSERT INTO [parCorteApelaciones] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodCorteApelacion], [Descripcion], [IndVigencia] FROM [parCorteApelaciones] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parCorteApelaciones] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCorteApelacion] = @CodCorteApelacion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodCorteApelacion" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodCorteApelacion" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parCorteApelaciones] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodCorteApelacion], [Descripcion], [IndVigencia] FROM [parCorteApelaciones]"
                            UpdateCommand="UPDATE [parCorteApelaciones] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCorteApelacion] = @CodCorteApelacion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodCorteApelacion" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parCorteApelaciones] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parCorteApelaciones AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parCorteApelaciones] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCorteApelacion] = @CodCorteApelacion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodCorteApelacion" Type="Int16" />
                            </DeleteParameters>
