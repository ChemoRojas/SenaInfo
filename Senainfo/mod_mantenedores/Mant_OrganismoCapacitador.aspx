<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_OrganismoCapacitador.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Organismo Capacitador </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodOrganismoCapacitador" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodOrganismoCapacitador" HeaderText="CodOrganismoCapacitador"
                                    ReadOnly="True" SortExpression="CodOrganismoCapacitador">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parOrganismoCapacitador] WHERE [CodOrganismoCapacitador] = @CodOrganismoCapacitador"
                            InsertCommand="INSERT INTO [parOrganismoCapacitador] ([Nombre], [Telefono], [IndVigencia]) VALUES (@Nombre, @Telefono, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodOrganismoCapacitador], [Nombre], [Telefono], [IndVigencia] FROM [parOrganismoCapacitador] WHERE ([Nombre] LIKE '%' + @Nombre + '%')"
                            UpdateCommand="UPDATE [parOrganismoCapacitador] SET [Nombre] = @Nombre, [Telefono] = @Telefono, [IndVigencia] = @IndVigencia WHERE [CodOrganismoCapacitador] = @CodOrganismoCapacitador">
                            <DeleteParameters>
                                <asp:Parameter Name="CodOrganismoCapacitador" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodOrganismoCapacitador" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parOrganismoCapacitador] ([Nombre], [Telefono], [IndVigencia]) VALUES (@Nombre, @Telefono, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodOrganismoCapacitador], [Nombre], [Telefono], [IndVigencia] FROM [parOrganismoCapacitador]"
                            UpdateCommand="UPDATE [parOrganismoCapacitador] SET [Nombre] = @Nombre, [Telefono] = @Telefono, [IndVigencia] = @IndVigencia WHERE [CodOrganismoCapacitador] = @CodOrganismoCapacitador">
                            <DeleteParameters>
                                <asp:Parameter Name="CodOrganismoCapacitador" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parOrganismoCapacitador] ([Nombre], [Telefono], [IndVigencia]) VALUES (@Nombre, @Telefono, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parOrganismoCapacitador AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parOrganismoCapacitador] SET [Nombre] = @Nombre, [Telefono] = @Telefono, [IndVigencia] = @IndVigencia WHERE [CodOrganismoCapacitador] = @CodOrganismoCapacitador">
                            <InsertParameters>
                                <asp:Parameter Name="Nombre" Type="String" />
                                <asp:Parameter Name="Telefono" Type="String" />
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                            ...
                                            <tr>
                                                <td class="texto_form">Tel&eacute;fono</td>
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox3" runat="server" Width="150px" MaxLength="10" Font-Size="11px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
