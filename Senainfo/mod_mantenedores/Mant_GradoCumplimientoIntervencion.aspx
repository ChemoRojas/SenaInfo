<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_GradoCumplimientoIntervencion.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Grado de Cumplimiento Intervenci&oacute;n </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="CodGradoCumplimiento" DataSourceID="SqlDataSource1" EmptyDataText="There are no data records to display." Visible="False" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None">
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodGradoCumplimiento" HeaderText="CodGradoCumplimiento"
                                    ReadOnly="True" SortExpression="CodGradoCumplimiento">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parGradoCumplimientoIntervencion] WHERE [CodGradoCumplimiento] = @CodGradoCumplimiento"
                            InsertCommand="INSERT INTO [parGradoCumplimientoIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodGradoCumplimiento], [Descripcion], [IndVigencia] FROM [parGradoCumplimientoIntervencion] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parGradoCumplimientoIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodGradoCumplimiento] = @CodGradoCumplimiento">
                            <InsertParameters>
                            ...
                            <UpdateParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                                <asp:Parameter Name="CodGradoCumplimiento" Type="Int16" />
                            </UpdateParameters>
                            <DeleteParameters>
                                <asp:Parameter Name="CodGradoCumplimiento" Type="Int16" />
                            </DeleteParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodGradoCumplimiento" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parGradoCumplimientoIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodGradoCumplimiento], [Descripcion], [IndVigencia] FROM [parGradoCumplimientoIntervencion]"
                            UpdateCommand="UPDATE [parGradoCumplimientoIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodGradoCumplimiento] = @CodGradoCumplimiento">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parGradoCumplimientoIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parGradoCumplimientoIntervencion AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parGradoCumplimientoIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodGradoCumplimiento] = @CodGradoCumplimiento">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
