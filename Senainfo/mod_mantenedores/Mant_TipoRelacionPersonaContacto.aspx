<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_TipoRelacionPersonaContacto.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Relaci&oacute;n Persona de Contacto </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodTipoRelacionPersonaContacto" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodTipoRelacionPersonaContacto" HeaderText="CodTipoRelacionPersonaContacto"
                                    ReadOnly="True" SortExpression="CodTipoRelacionPersonaContacto">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTipoRelacionPersonaContacto] WHERE [CodTipoRelacionPersonaContacto] = @CodTipoRelacionPersonaContacto"
                            InsertCommand="INSERT INTO [parTipoRelacionPersonaContacto] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodTipoRelacionPersonaContacto], [Descripcion], [IndVigencia] FROM [parTipoRelacionPersonaContacto] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parTipoRelacionPersonaContacto] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodTipoRelacionPersonaContacto] = @CodTipoRelacionPersonaContacto">
                            <DeleteParameters>
                                <asp:Parameter Name="CodTipoRelacionPersonaContacto" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodTipoRelacionPersonaContacto" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoRelacionPersonaContacto] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodTipoRelacionPersonaContacto], [Descripcion], [IndVigencia] FROM [parTipoRelacionPersonaContacto]"
                            UpdateCommand="UPDATE [parTipoRelacionPersonaContacto] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodTipoRelacionPersonaContacto] = @CodTipoRelacionPersonaContacto">
                            <DeleteParameters>
                                <asp:Parameter Name="CodTipoRelacionPersonaContacto" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoRelacionPersonaContacto] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoRelacionPersonaContacto AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoRelacionPersonaContacto] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodTipoRelacionPersonaContacto] = @CodTipoRelacionPersonaContacto">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
