<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_TipoOrganizacionSocial.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Organizaci&oacute;n Social </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="350">
                                    <asp:TextBox ID="TextBox1" runat="server" OnTextChanged="TextBox1_TextChanged" Font-Size="11px" Width="350px"></asp:TextBox></td>
                                <td>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoOrganizacionSocial" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="TipoOrganizacionSocial" HeaderText="TipoOrganizacionSocial"
                                    ReadOnly="True" SortExpression="TipoOrganizacionSocial">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTipoOrganizacionSocial] WHERE [TipoOrganizacionSocial] = @TipoOrganizacionSocial"
                            InsertCommand="INSERT INTO [parTipoOrganizacionSocial] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoOrganizacionSocial], [Descripcion], [IndVigencia] FROM [parTipoOrganizacionSocial] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parTipoOrganizacionSocial] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoOrganizacionSocial] = @TipoOrganizacionSocial">
                            <InsertParameters>
                            ...
                            <UpdateParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                                <asp:Parameter Name="TipoOrganizacionSocial" Type="Int16" />
                            </UpdateParameters>
                            <DeleteParameters>
                                <asp:Parameter Name="TipoOrganizacionSocial" Type="Int16" />
                            </DeleteParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoOrganizacionSocial" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoOrganizacionSocial] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoOrganizacionSocial], [Descripcion], [IndVigencia] FROM [parTipoOrganizacionSocial]"
                            UpdateCommand="UPDATE [parTipoOrganizacionSocial] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoOrganizacionSocial] = @TipoOrganizacionSocial">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoOrganizacionSocial] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoOrganizacionSocial RIGHT OUTER JOIN dbo.parDominios AS pD ON dbo.parTipoOrganizacionSocial.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoOrganizacionSocial] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoOrganizacionSocial] = @TipoOrganizacionSocial">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoOrganizacionSocial" Type="Int16" />
                            </DeleteParameters>
