<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_TipoTribunal.aspx.cs" Inherits="Mant_TipoTribunal" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Tribunal </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoTribunal" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="TipoTribunal" HeaderText="TipoTribunal" ReadOnly="True"
                                    SortExpression="TipoTribunal">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTipoTribunal] WHERE [TipoTribunal] = @TipoTribunal"
                            InsertCommand="INSERT INTO [parTipoTribunal] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoTribunal], [Descripcion], [IndVigencia] FROM [parTipoTribunal] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parTipoTribunal] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoTribunal] = @TipoTribunal">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoTribunal" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoTribunal" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoTribunal] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoTribunal], [Descripcion], [IndVigencia] FROM [parTipoTribunal]"
                            UpdateCommand="UPDATE [parTipoTribunal] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoTribunal] = @TipoTribunal">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoTribunal" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoTribunal] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoTribunal AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')
"
                            UpdateCommand="UPDATE [parTipoTribunal] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoTribunal] = @TipoTribunal">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoTribunal" Type="Int16" />
