<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_Actividad.aspx.cs" Inherits="Mant_Actividad" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Actividad </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodActividad" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodActividad" HeaderText="CodActividad" ReadOnly="True"
                                    SortExpression="CodActividad">
                                ...
                                <asp:TemplateField HeaderText="IndVigencia">
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource3" DataTextField="Tabla_Descripcion" DataValueField="Tabla_Valor" SelectedValue='<%# Bind("IndVigencia") %>'></asp:DropDownList>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:senainfoConnectionString %>"
                            DeleteCommand="DELETE FROM [parActividad] WHERE [CodActividad] = @CodActividad"
                            InsertCommand="INSERT INTO [parActividad] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:senainfoConnectionString.ProviderName %>"
                            SelectCommand="SELECT [CodActividad], [Descripcion], [IndVigencia] FROM [parActividad]"
                            UpdateCommand="UPDATE [parActividad] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodActividad] = @CodActividad">
                            <DeleteParameters>
                                <asp:Parameter Name="CodActividad" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodActividad" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:senainfoConnectionString %>"
                            DeleteCommand="DELETE FROM [parActividad] WHERE [CodActividad] = @CodActividad"
                            InsertCommand="INSERT INTO [parActividad] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:senainfoConnectionString.ProviderName %>"
                            SelectCommand="SELECT [CodActividad], [Descripcion], [IndVigencia] FROM [parActividad] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parActividad] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodActividad] = @CodActividad">
                            <DeleteParameters>
                                <asp:Parameter Name="CodActividad" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:senainfoConnectionString %>"
                            DeleteCommand="DELETE FROM [parActividad] WHERE [CodActividad] = @CodActividad"
                            InsertCommand="INSERT INTO [parActividad] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:senainfoConnectionString.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parActividad RIGHT OUTER JOIN dbo.parDominios AS pD ON dbo.parActividad.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parActividad] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodActividad] = @CodActividad">
                            <DeleteParameters>
                                <asp:Parameter Name="CodActividad" Type="Int16" />
                            </DeleteParameters>
