<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_SistemaAsistencial.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Sistema Asistencia </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodSistemaAsistencial" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodSistemaAsistencial" HeaderText="CodSistemaAsistencial"
                                    ReadOnly="True" SortExpression="CodSistemaAsistencial">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parSistemaAsistencial] WHERE [CodSistemaAsistencial] = @CodSistemaAsistencial"
                            InsertCommand="INSERT INTO [parSistemaAsistencial] ([CodNemotecnico], [Descripcion], [IndVigencia]) VALUES (@CodNemotecnico, @Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodSistemaAsistencial], [CodNemotecnico], [Descripcion], [IndVigencia] FROM [parSistemaAsistencial] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parSistemaAsistencial] SET [CodNemotecnico] = @CodNemotecnico, [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodSistemaAsistencial] = @CodSistemaAsistencial">
                            <InsertParameters>
                            ...
                            <UpdateParameters>
                                ...
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                                <asp:Parameter Name="CodSistemaAsistencial" Type="Int16" />
                            </UpdateParameters>
                            <DeleteParameters>
                                <asp:Parameter Name="CodSistemaAsistencial" Type="Int16" />
                            </DeleteParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodSistemaAsistencial" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parSistemaAsistencial] ([CodNemotecnico], [Descripcion], [IndVigencia]) VALUES (@CodNemotecnico, @Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodSistemaAsistencial], [CodNemotecnico], [Descripcion], [IndVigencia] FROM [parSistemaAsistencial]"
                            UpdateCommand="UPDATE [parSistemaAsistencial] SET [CodNemotecnico] = @CodNemotecnico, [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodSistemaAsistencial] = @CodSistemaAsistencial">
                            <InsertParameters>
                                <asp:Parameter Name="CodNemotecnico" Type="String" />
                                <asp:Parameter Name="Descripcion" Type="String" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parSistemaAsistencial] ([CodNemotecnico], [Descripcion], [IndVigencia]) VALUES (@CodNemotecnico, @Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parSistemaAsistencial AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parSistemaAsistencial] SET [CodNemotecnico] = @CodNemotecnico, [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodSistemaAsistencial] = @CodSistemaAsistencial">
                            <DeleteParameters>
                                <asp:Parameter Name="CodSistemaAsistencial" Type="Int16" />
                            </DeleteParameters>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                            <tr>
                                                <td width="225" class="texto_form">Nemotecnico</td>
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox2" runat="server" Width="50px" MaxLength="3" Font-Size="11px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
