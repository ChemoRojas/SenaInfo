<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editarModulo.aspx.cs" Inherits="mod_mantenedores_editarModulo" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function volver() {
            window.location = "Mant_Modulos.aspx"
        }
    </script>
</head>
<body>
         ...
         <div class="alert alert-warning text-center" role="alert" id="alertW" runat="server" visible="false">
             ...
             <div class="well" id="grabar" visible="true" runat="server">
                  ...
                  <table class="table table-bordered  table-condensed">
                                    ...
                                    <asp:TextBox ID="txtCodModulo" runat="server" MaxLength="100" CssClass="form-control input-sm"  Visible="false" ></asp:TextBox>
