...
public partial class mod_mantenedores_Mant_PreguntasDiagnostico : System.Web.UI.Page
{
    public int vCodPaso
    {
        ...
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    string consulta = "SELECT p.CodPregunta, p.Texto, a.NombreArea, p.Orden, p.Tipo, p.Vigencia FROM PreguntaDiagnostico p INNER JOIN Area a ON p.CodArea = a.CodArea WHERE a.PreguntaPadre = " + codPregunta;
                    ...
                    {
                        String nombrePreguntaEliminar = (String)datareader1["Texto"];
                        int Vigencia = 0;
