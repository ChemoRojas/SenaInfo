<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_Modulos.aspx.cs" Inherits="mod_mantenedores_Mant_Modulos" %>
            ...
            <ContentTemplate>
                ...
                <div class="container theme-showcase" role="main">
                    ...
                    <div class="alert alert-success text-center" role="alert" id="alertS" runat="server" visible="false">
                        <span class="glyphicon glyphicon-ok"></span>Datos del Módulo registrados satisfactoriamente.
                          ...
                          <div class="row" visible="true" id="buscar" runat="server">
                                              ...
                                              <tr>
                                                  ...
                                                  <td>
                                                      <div class="input-group">
                                                          <asp:TextBox ID="txtCodModulo" runat="server" CssClass="form-control input-sm" onkeypress="return numbersonly(event);"></asp:TextBox>
                                                      </div>
                                ...
                                <asp:Panel ID="panelInfoBusqueda" runat="server" CssClass="panel-info panel-primary-info">
                                    ...
                                    <div class="panel-footer">
                                        <asp:Label ID="Lbl_Info1" CssClass="subtitulo-form-info" runat="server" Text="Ingrese código del Módulo." ></asp:Label><br />
                                        ...
                                        <asp:Panel ID="lbl002panel" runat="server" Visible="false" CssClass="text-center">
                                            ...
                                            <asp:Label ID="lbl002" runat="server">0</asp:Label></label></h4>
                                                    ...
                                                    <asp:GridView ID="grdBusqueda" runat="server" AutoGenerateColumns="False" CellPadding="4" GridLines="None" CssClass="table table table-bordered table-hover">
                                                        ...
                                                        <Columns>
                                                            <asp:BoundField DataField="CodModulo" HeaderText="Código del Módulo" />
                                                            <asp:BoundField DataField="NombreModulo" HeaderText="Nombre del Módulo" />
                                                            <asp:BoundField DataField="NombreObjetivo" HeaderText="Objetivo" />
                                                            <asp:BoundField DataField="Vigencia" HeaderText="Vigencia" />
                                                            <asp:BoundField DataField="CodModulo" HtmlEncode="False" DataFormatString="<a href='editarModulo.aspx?CodModulo={0}'>Editar</a>" HeaderText="Editar" ItemStyle-HorizontalAlign="Center" />
                                                            <asp:BoundField DataField="CodModulo" HtmlEncode="False" DataFormatString="<a href='Mant_Modulos.aspx?CodModulo={0}'>Cambiar Vigencia</a>" HeaderText="Cambiar Vigencia" ItemStyle-HorizontalAlign="Center" />
                                                        </Columns>
                        ...
                        <h4 class="subtitulo-form">Objetivos</h4>
                                ...
                                <table class="table table-bordered  table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <th class="titulo-tabla" scope="row">Nombre del Módulo *</th>
                                        <td colspan="3" class="col-md-8">
                                            
                                                <asp:TextBox ID="txtModulo" runat="server" MaxLength="100" CssClass="form-control input-sm" placeholder="Ingrese nombre de objetivo" ></asp:TextBox>
                                    ...
                                    <tr>
                                                ...
                                                <th class="titulo-tabla" scope="row">Objetivo *</th>
                                        <td colspan="3" class="col-md-8">
                                                <asp:DropDownList ID="ddownObjetivo" runat="server" CssClass="form-control input-sm">
