<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_Actividades.aspx.cs" Inherits="mod_mantenedores_Mant_Actividades" %>
...
<head id="Head1" runat="server">
    ...
    <title>Mantenedor de Actividades :: Senainfo :: Servicio Nacional de Menores</title>
            ...
            <ContentTemplate>
                ...
                <div class="container theme-showcase" role="main">
                    ...
                    <div class="alert alert-success text-center" role="alert" id="alertS" runat="server" visible="false">
                        <span class="glyphicon glyphicon-ok"></span>Datos de la actividad registrados satisfactoriamente.
                          ...
                          <div class="row" visible="true" id="buscar" runat="server">
                                  <div class="col-md-9">
                                      <form action="">
                                          <table class="table table-borderless table-condensed table-col-fix">
                                              <tr>
                                                  <th class="col-md-3">
                                                      <label for="">Código de la Actividad:</label>
                                                  </th>
                                                  <td>
                                                      <div class="input-group">
                                                          <asp:TextBox ID="txtCodActividad" runat="server" CssClass="form-control input-sm" onkeypress="return numbersonly(event);"></asp:TextBox>
                                                      </div>
                                ...
                                <asp:Panel ID="panelInfoBusqueda" runat="server" CssClass="panel-info panel-primary-info">
                                    ...
                                    <div class="panel-footer">
                                        <asp:Label ID="Lbl_Info1" CssClass="subtitulo-form-info" runat="server" Text="Ingrese código de la Actividad." ></asp:Label><br />
                                        ...
                                        <asp:Panel ID="lbl002panel" runat="server" Visible="false" CssClass="text-center">
                                            ...
                                            <asp:Label ID="lbl002" runat="server">0</asp:Label></label></h4>
                                                    ...
                                                    <asp:GridView ID="grdBusqueda" runat="server" AutoGenerateColumns="False" CellPadding="4" GridLines="None" CssClass="table table table-bordered table-hover">
                                                        ...
                                                        <Columns>
                                                            <asp:BoundField DataField="CodActividad" HeaderText="Código de la Actividad" />
                                                            ...
                                                            <asp:BoundField DataField="CodActividad" HtmlEncode="False" DataFormatString="<a href='editarActividad.aspx?CodActividad={0}'>Editar</a>" HeaderText="Editar" ItemStyle-HorizontalAlign="Center" />
                                                            <asp:BoundField DataField="CodActividad" HtmlEncode="False" DataFormatString="<a href='Mant_Actividades.aspx?CodActividad={0}'>Cambiar Vigencia</a>" HeaderText="Cambiar Vigencia" ItemStyle-HorizontalAlign="Center" />
                                                        </Columns>
