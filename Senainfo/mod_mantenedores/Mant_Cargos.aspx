<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_Cargos.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Cargos </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodCargo" DataSourceID="SqlDataSource1"
                            EmptyDataText="There are no data records to display." Visible="False" Font-Size="11px" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None">
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodCargo" HeaderText="CodCargo" ReadOnly="True" SortExpression="CodCargo">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parCargos] WHERE [CodCargo] = @CodCargo" InsertCommand="INSERT INTO [parCargos] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodCargo], [Descripcion], [IndVigencia] FROM [parCargos] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parCargos] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCargo] = @CodCargo">
                            <DeleteParameters>
                                <asp:Parameter Name="CodCargo" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodCargo" DataSourceID="SqlDataSource2"
                            EmptyDataText="There are no data records to display." Font-Size="11px" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None">
                            <Columns>
                                <asp:CommandField ShowEditButton="True" CancelText="Cancelar" DeleteText="Borrar" EditText="Modificar" InsertText="Insertar" NewText="Nuevo" SelectText="Seleccionar" UpdateText="Actualizar">
                                    <ItemStyle Font-Size="11px" ForeColor="Red" />
                                </asp:CommandField>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parCargos] WHERE [CodCargo] = @CodCargo" InsertCommand="INSERT INTO [parCargos] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodCargo], [Descripcion], [IndVigencia] FROM [parCargos]"
                            UpdateCommand="UPDATE [parCargos] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCargo] = @CodCargo">
                            <DeleteParameters>
                                <asp:Parameter Name="CodCargo" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parCargos] WHERE [CodCargo] = @CodCargo" InsertCommand="INSERT INTO [parCargos] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parCargos AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parCargos] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCargo] = @CodCargo">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
