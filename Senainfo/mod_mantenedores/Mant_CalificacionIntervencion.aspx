<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_CalificacionIntervencion.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Calificaci&oacute;n de Intervenci&oacute;n </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="350" style="height: 34px">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodCalificacionIntervencion" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodCalificacionIntervencion" HeaderText="CodCalificacionIntervencion"
                                    ReadOnly="True" SortExpression="CodCalificacionIntervencion">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parCalificacionIntervencion] WHERE [CodCalificacionIntervencion] = @CodCalificacionIntervencion"
                            InsertCommand="INSERT INTO [parCalificacionIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodCalificacionIntervencion], [Descripcion], [IndVigencia] FROM [parCalificacionIntervencion] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parCalificacionIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCalificacionIntervencion] = @CodCalificacionIntervencion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodCalificacionIntervencion" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodCalificacionIntervencion" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parCalificacionIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodCalificacionIntervencion], [Descripcion], [IndVigencia] FROM [parCalificacionIntervencion]"
                            UpdateCommand="UPDATE [parCalificacionIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCalificacionIntervencion] = @CodCalificacionIntervencion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodCalificacionIntervencion" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parCalificacionIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parCalificacionIntervencion AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parCalificacionIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCalificacionIntervencion] = @CodCalificacionIntervencion">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
