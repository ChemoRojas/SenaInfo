<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_QuienOcasionaLesion.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Quien Ocasiona Lesi&oacute;n </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodQuienOcasionaLesion" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodQuienOcasionaLesion" HeaderText="CodQuienOcasionaLesion"
                                    ReadOnly="True" SortExpression="CodQuienOcasionaLesion">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parQuienOcasionaLesion] WHERE [CodQuienOcasionaLesion] = @CodQuienOcasionaLesion"
                            InsertCommand="INSERT INTO [parQuienOcasionaLesion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodQuienOcasionaLesion], [Descripcion], [IndVigencia] FROM [parQuienOcasionaLesion] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parQuienOcasionaLesion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodQuienOcasionaLesion] = @CodQuienOcasionaLesion">
                            <InsertParameters>
                            ...
                            <UpdateParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                                <asp:Parameter Name="CodQuienOcasionaLesion" Type="Int16" />
                            </UpdateParameters>
                            <DeleteParameters>
                                <asp:Parameter Name="CodQuienOcasionaLesion" Type="Int16" />
                            </DeleteParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodQuienOcasionaLesion" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parQuienOcasionaLesion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodQuienOcasionaLesion], [Descripcion], [IndVigencia] FROM [parQuienOcasionaLesion]"
                            UpdateCommand="UPDATE [parQuienOcasionaLesion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodQuienOcasionaLesion] = @CodQuienOcasionaLesion">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parQuienOcasionaLesion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parQuienOcasionaLesion AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parQuienOcasionaLesion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodQuienOcasionaLesion] = @CodQuienOcasionaLesion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodQuienOcasionaLesion" Type="Int16" />
                            </DeleteParameters>
