<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_MedioPago.aspx.cs" Inherits="Mant_MedioPago" %>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodMedioDePago" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodMedioDePago" HeaderText="CodMedioDePago" ReadOnly="True"
                                    SortExpression="CodMedioDePago">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parMedioDePago] WHERE [CodMedioDePago] = @CodMedioDePago"
                            InsertCommand="INSERT INTO [parMedioDePago] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodMedioDePago], [Descripcion], [IndVigencia] FROM [parMedioDePago]"
                            UpdateCommand="UPDATE [parMedioDePago] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodMedioDePago] = @CodMedioDePago">
                            <DeleteParameters>
                                <asp:Parameter Name="CodMedioDePago" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodMedioDePago" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parMedioDePago] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodMedioDePago], [Descripcion], [IndVigencia] FROM [parMedioDePago] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parMedioDePago] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodMedioDePago] = @CodMedioDePago">
                            <DeleteParameters>
                                <asp:Parameter Name="CodMedioDePago" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parMedioDePago] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parMediodePago RIGHT OUTER JOIN dbo.parDominios AS pD ON dboparMediodePago.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parMedioDePago] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodMedioDePago] = @CodMedioDePago">
                            <DeleteParameters>
                                <asp:Parameter Name="CodMedioDePago" Type="Int16" />
                            </DeleteParameters>
                                ...
                                <tr>
                                    <td>
                                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Images/Botones/guardar2.gif"
                                            OnClick="ImageButton2_Click1" /><asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Images/Botones/Cancelar2.gif"
