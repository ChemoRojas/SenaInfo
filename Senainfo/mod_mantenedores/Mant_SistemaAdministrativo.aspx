<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_SistemaAdministrativo.aspx.cs" Inherits="Mant_SistemaAdministrativo" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Sistema Administrativo </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="codSistemaAdministrativo" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="codSistemaAdministrativo" HeaderText="codSistemaAdministrativo"
                                    ReadOnly="True" SortExpression="codSistemaAdministrativo">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parSistemaAdministrativo] WHERE [codSistemaAdministrativo] = @codSistemaAdministrativo"
                            InsertCommand="INSERT INTO [parSistemaAdministrativo] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [codSistemaAdministrativo], [Descripcion], [IndVigencia] FROM [parSistemaAdministrativo] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parSistemaAdministrativo] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [codSistemaAdministrativo] = @codSistemaAdministrativo">
                            <DeleteParameters>
                                <asp:Parameter Name="codSistemaAdministrativo" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="codSistemaAdministrativo" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parSistemaAdministrativo] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [codSistemaAdministrativo], [Descripcion], [IndVigencia] FROM [parSistemaAdministrativo]"
                            UpdateCommand="UPDATE [parSistemaAdministrativo] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [codSistemaAdministrativo] = @codSistemaAdministrativo">
                            <DeleteParameters>
                                <asp:Parameter Name="codSistemaAdministrativo" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parSistemaAdministrativo] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parSistemaAdministrativo AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parSistemaAdministrativo] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [codSistemaAdministrativo] = @codSistemaAdministrativo">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
