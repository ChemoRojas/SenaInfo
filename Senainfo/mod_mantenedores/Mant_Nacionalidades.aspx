<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_Nacionalidades.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Nacionalidades </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodNacionalidad" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodNacionalidad" HeaderText="CodNacionalidad" ReadOnly="True"
                                    SortExpression="CodNacionalidad">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="CodIntenacional" HeaderText="CodIntenacional" SortExpression="CodIntenacional">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parNacionalidades] WHERE [CodNacionalidad] = @CodNacionalidad"
                            InsertCommand="INSERT INTO [parNacionalidades] ([CodIntenacional], [Descripcion], [IndVigencia]) VALUES (@CodIntenacional, @Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodNacionalidad], [CodIntenacional], [Descripcion], [IndVigencia] FROM [parNacionalidades] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parNacionalidades] SET [CodIntenacional] = @CodIntenacional, [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodNacionalidad] = @CodNacionalidad">
                            <InsertParameters>
                                <asp:Parameter Name="CodIntenacional" Type="String" />
                            ...
                            <UpdateParameters>
                                ...
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                                <asp:Parameter Name="CodNacionalidad" Type="Int16" />
                            </UpdateParameters>
                            <DeleteParameters>
                                <asp:Parameter Name="CodNacionalidad" Type="Int16" />
                            </DeleteParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodNacionalidad" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parNacionalidades] ([CodIntenacional], [Descripcion], [IndVigencia]) VALUES (@CodIntenacional, @Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodNacionalidad], [CodIntenacional], [Descripcion], [IndVigencia] FROM [parNacionalidades]"
                            UpdateCommand="UPDATE [parNacionalidades] SET [CodIntenacional] = @CodIntenacional, [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodNacionalidad] = @CodNacionalidad">
                            <InsertParameters>
                                <asp:Parameter Name="CodIntenacional" Type="String" />
                                <asp:Parameter Name="Descripcion" Type="String" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parNacionalidades] ([CodIntenacional], [Descripcion], [IndVigencia]) VALUES (@CodIntenacional, @Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parNacionalidades AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parNacionalidades] SET [CodIntenacional] = @CodIntenacional, [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodNacionalidad] = @CodNacionalidad">
                            <InsertParameters>
                                <asp:Parameter Name="CodIntenacional" Type="String" />
                                <asp:Parameter Name="Descripcion" Type="String" />
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                            <tr>
                                                <td width="225" class="texto_form">C&oacute;digo Internacional</td>
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox2" runat="server" Width="50px" OnTextChanged="TextBox2_TextChanged" MaxLength="2" Font-Size="11px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="texto_form">Descripci&oacute;n</td>
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox3" runat="server" Width="650px" Font-Size="11px" MaxLength="200" TextMode="MultiLine"></asp:TextBox></td>
                                            </tr>
                                            <tr>
