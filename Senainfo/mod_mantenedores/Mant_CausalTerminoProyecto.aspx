<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_CausalTerminoProyecto.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Causal T&eacute;rmino Proyecto </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodCausalTerminoProyecto" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodCausalTerminoProyecto" HeaderText="CodCausalTerminoProyecto"
                                    ReadOnly="True" SortExpression="CodCausalTerminoProyecto">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parCausalTerminoProyecto] WHERE [CodCausalTerminoProyecto] = @CodCausalTerminoProyecto"
                            InsertCommand="INSERT INTO [parCausalTerminoProyecto] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodCausalTerminoProyecto], [Descripcion], [IndVigencia] FROM [parCausalTerminoProyecto] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parCausalTerminoProyecto] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCausalTerminoProyecto] = @CodCausalTerminoProyecto">
                            <InsertParameters>
                            ...
                            <UpdateParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                                <asp:Parameter Name="CodCausalTerminoProyecto" Type="Int16" />
                            </UpdateParameters>
                            <DeleteParameters>
                                <asp:Parameter Name="CodCausalTerminoProyecto" Type="Int16" />
                            </DeleteParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodCausalTerminoProyecto" DataSourceID="SqlDataSource2"
                            EmptyDataText="There are no data records to display." Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None">
                            <Columns>
                                <asp:CommandField ShowEditButton="True" CancelText="Cancelar" DeleteText="Borrar" EditText="Editar" InsertText="Insertar" NewText="Nuevo" SelectText="Seleccionar" UpdateText="Actualizar">
                                    <ItemStyle Font-Size="11px" ForeColor="Red" />
                                </asp:CommandField>
                                <asp:BoundField DataField="CodCausalTerminoProyecto" HeaderText="CodCausalTerminoProyecto"
                                    ReadOnly="True" SortExpression="CodCausalTerminoProyecto">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parCausalTerminoProyecto] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodCausalTerminoProyecto], [Descripcion], [IndVigencia] FROM [parCausalTerminoProyecto]"
                            UpdateCommand="UPDATE [parCausalTerminoProyecto] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCausalTerminoProyecto] = @CodCausalTerminoProyecto">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parCausalTerminoProyecto] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parCausalTerminoProyecto AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parCausalTerminoProyecto] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCausalTerminoProyecto] = @CodCausalTerminoProyecto">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
