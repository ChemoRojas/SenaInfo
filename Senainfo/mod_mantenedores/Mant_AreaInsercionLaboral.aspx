<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_AreaInsercionLaboral.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Area Inserci&oacute;n Laboral </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodAreaInsercionLaboral" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodAreaInsercionLaboral" HeaderText="CodAreaInsercionLaboral"
                                    ReadOnly="True" SortExpression="CodAreaInsercionLaboral">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parAreaInsercionLaboral] WHERE [CodAreaInsercionLaboral] = @CodAreaInsercionLaboral"
                            InsertCommand="INSERT INTO [parAreaInsercionLaboral] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodAreaInsercionLaboral], [Descripcion], [IndVigencia] FROM [parAreaInsercionLaboral] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parAreaInsercionLaboral] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodAreaInsercionLaboral] = @CodAreaInsercionLaboral">
                            <DeleteParameters>
                                <asp:Parameter Name="CodAreaInsercionLaboral" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodAreaInsercionLaboral" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parAreaInsercionLaboral] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodAreaInsercionLaboral], [Descripcion], [IndVigencia] FROM [parAreaInsercionLaboral]"
                            UpdateCommand="UPDATE [parAreaInsercionLaboral] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodAreaInsercionLaboral] = @CodAreaInsercionLaboral">
                            <DeleteParameters>
                                <asp:Parameter Name="CodAreaInsercionLaboral" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parAreaInsercionLaboral] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parAreaInsercionLaboral AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parAreaInsercionLaboral] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodAreaInsercionLaboral] = @CodAreaInsercionLaboral">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                            ...
                                            <tr>
                                                <td width="225" class="texto_form">IndVigencia</td>
                                                <td class="linea_inferior">
