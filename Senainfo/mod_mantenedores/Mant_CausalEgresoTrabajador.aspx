<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_CausalEgresoTrabajador.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Causal Egreso Trabajador </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodCausalEgresoTrabajador" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodCausalEgresoTrabajador" HeaderText="CodCausalEgresoTrabajador"
                                    ReadOnly="True" SortExpression="CodCausalEgresoTrabajador">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parCausalEgresoTrabajador] WHERE [CodCausalEgresoTrabajador] = @CodCausalEgresoTrabajador"
                            InsertCommand="INSERT INTO [parCausalEgresoTrabajador] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodCausalEgresoTrabajador], [Descripcion], [IndVigencia] FROM [parCausalEgresoTrabajador] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parCausalEgresoTrabajador] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCausalEgresoTrabajador] = @CodCausalEgresoTrabajador">
                            <DeleteParameters>
                                <asp:Parameter Name="CodCausalEgresoTrabajador" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodCausalEgresoTrabajador" DataSourceID="SqlDataSource2"
                            EmptyDataText="There are no data records to display." Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None">
                            <Columns>
                                <asp:CommandField ShowEditButton="True" CancelText="Cancelar" DeleteText="Borrar" EditText="Modificar" InsertText="Insertar" NewText="Nuevo" SelectText="Seleccionar" UpdateText="Agregar">
                                    <ItemStyle Font-Size="11px" ForeColor="Red" />
                                </asp:CommandField>
                                <asp:BoundField DataField="CodCausalEgresoTrabajador" HeaderText="CodCausalEgresoTrabajador"
                                    ReadOnly="True" SortExpression="CodCausalEgresoTrabajador">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parCausalEgresoTrabajador] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodCausalEgresoTrabajador], [Descripcion], [IndVigencia] FROM [parCausalEgresoTrabajador]"
                            UpdateCommand="UPDATE [parCausalEgresoTrabajador] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCausalEgresoTrabajador] = @CodCausalEgresoTrabajador">
                            <DeleteParameters>
                                <asp:Parameter Name="CodCausalEgresoTrabajador" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parCausalEgresoTrabajador] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parCausalEgresoTrabajador AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parCausalEgresoTrabajador] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodCausalEgresoTrabajador] = @CodCausalEgresoTrabajador">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
