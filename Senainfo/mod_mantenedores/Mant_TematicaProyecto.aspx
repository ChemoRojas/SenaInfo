<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_TematicaProyecto.aspx.cs" Inherits="Mant_TematicaProyecto" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Temática Proyecto </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodTematicaProyecto" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodTematicaProyecto" HeaderText="CodTematicaProyecto"
                                    ReadOnly="True" SortExpression="CodTematicaProyecto">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTematicaProyecto] WHERE [CodTematicaProyecto] = @CodTematicaProyecto"
                            InsertCommand="INSERT INTO [parTematicaProyecto] ([Descripcion], [IndVigencia], [Peso]) VALUES (@Descripcion, @IndVigencia, @Peso)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodTematicaProyecto], [Descripcion], [IndVigencia], [Peso] FROM [parTematicaProyecto]"
                            UpdateCommand="UPDATE [parTematicaProyecto] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia, [Peso] = @Peso WHERE [CodTematicaProyecto] = @CodTematicaProyecto">
                            <DeleteParameters>
                                <asp:Parameter Name="CodTematicaProyecto" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodTematicaProyecto" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTematicaProyecto] ([Descripcion], [IndVigencia], [Peso]) VALUES (@Descripcion, @IndVigencia, @Peso)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodTematicaProyecto], [Descripcion], [IndVigencia], [Peso] FROM [parTematicaProyecto] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parTematicaProyecto] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia, [Peso] = @Peso WHERE [CodTematicaProyecto] = @CodTematicaProyecto">
                            <DeleteParameters>
                                <asp:Parameter Name="CodTematicaProyecto" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTematicaProyecto] ([Descripcion], [IndVigencia], [Peso]) VALUES (@Descripcion, @IndVigencia, @Peso)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTematicaProyecto RIGHT OUTER JOIN dbo.parDominios AS pD ON dbo.parTematicaProyecto.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTematicaProyecto] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia, [Peso] = @Peso WHERE [CodTematicaProyecto] = @CodTematicaProyecto">
                            <DeleteParameters>
                                <asp:Parameter Name="CodTematicaProyecto" Type="Int16" />
                            </DeleteParameters>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                            ...
                                            <tr>
                                                <td class="texto_form">Peso</td>
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox3" runat="server" Width="350px" MaxLength="3" Font-Size="11px">0</asp:TextBox></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
