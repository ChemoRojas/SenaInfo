<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_TipoLesiones.aspx.cs" Inherits="Mant_TipoLesiones" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Lesiones </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoLesiones" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="TipoLesiones" HeaderText="TipoLesiones" ReadOnly="True"
                                    SortExpression="TipoLesiones">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            SelectCommand="SELECT [TipoLesiones], [Descripcion], [IndVigencia] FROM [parTipoLesiones]"
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoLesiones" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoLesiones] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoLesiones], [Descripcion], [IndVigencia] FROM [parTipoLesiones] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parTipoLesiones] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoLesiones] = @TipoLesiones">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoLesiones" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoLesiones] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoLesiones RIGHT OUTER JOIN dbo.parDominios AS pD ON dbo.parTipoLesiones.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoLesiones] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoLesiones] = @TipoLesiones">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoLesiones" Type="Int16" />
                            </DeleteParameters>
