<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_EnfermedadesCronicas.aspx.cs" Inherits="Mant_EnfermedadesCronicas" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Enfermedades Crónicas </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
                            AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="CodEnfermedadCronica"
                            DataSourceID="SqlDataSource1" EmptyDataText="No hay registros de datos para mostrar." Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None">
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodEnfermedadCronica" HeaderText="CodEnfermedadCronica"
                                    ReadOnly="True" SortExpression="CodEnfermedadCronica">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parEnfermedadesCronicas] WHERE [CodEnfermedadCronica] = @CodEnfermedadCronica"
                            InsertCommand="INSERT INTO [parEnfermedadesCronicas] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodEnfermedadCronica], [Descripcion], [IndVigencia] FROM [parEnfermedadesCronicas]"
                            UpdateCommand="UPDATE [parEnfermedadesCronicas] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodEnfermedadCronica] = @CodEnfermedadCronica">
                            <DeleteParameters>
                                <asp:Parameter Name="CodEnfermedadCronica" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodEnfermedadCronica" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parEnfermedadesCronicas] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodEnfermedadCronica], [Descripcion], [IndVigencia] FROM [parEnfermedadesCronicas] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parEnfermedadesCronicas] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodEnfermedadCronica] = @CodEnfermedadCronica">
                            <DeleteParameters>
                                <asp:Parameter Name="CodEnfermedadCronica" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parEnfermedadesCronicas] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parEnfermedadesCronicas RIGHT OUTER JOIN dbo.parDominios AS pD ON dbo.parEnfermedadesCronicas.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parEnfermedadesCronicas] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodEnfermedadCronica] = @CodEnfermedadCronica">
                            <DeleteParameters>
                                <asp:Parameter Name="CodEnfermedadCronica" Type="Int16" />
                            </DeleteParameters>
