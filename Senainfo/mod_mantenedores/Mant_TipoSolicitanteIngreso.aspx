<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_TipoSolicitanteIngreso.aspx.cs" Inherits="Mant_TipoSolicitanteIngreso" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Solicitante de Ingreso </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoSolicitanteIngreso" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="TipoSolicitanteIngreso" HeaderText="TipoSolicitanteIngreso"
                                    ReadOnly="True" SortExpression="TipoSolicitanteIngreso">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            SelectCommand="SELECT [TipoSolicitanteIngreso], [Descripcion], [IndVigencia] FROM [parTipoSolicitanteIngreso] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoSolicitanteIngreso" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoSolicitanteIngreso] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoSolicitanteIngreso AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoSolicitanteIngreso] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoSolicitanteIngreso] = @TipoSolicitanteIngreso">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoSolicitanteIngreso" Type="Int16" />
                            </DeleteParameters>
