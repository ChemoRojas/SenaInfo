<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_DepartamentosSENAME.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Departamento SENAME </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodDepartamentosSENAME" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodDepartamentosSENAME" HeaderText="CodDepartamentosSENAME"
                                    ReadOnly="True" SortExpression="CodDepartamentosSENAME">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parDepartamentosSENAME] WHERE [CodDepartamentosSENAME] = @CodDepartamentosSENAME"
                            InsertCommand="INSERT INTO [parDepartamentosSENAME] ([Nombre], [NombreCorto], [IndVigencia]) VALUES (@Nombre, @NombreCorto, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodDepartamentosSENAME], [Nombre], [NombreCorto], [IndVigencia] FROM [parDepartamentosSENAME] WHERE ([Nombre] LIKE '%' + @Nombre + '%')"
                            UpdateCommand="UPDATE [parDepartamentosSENAME] SET [Nombre] = @Nombre, [NombreCorto] = @NombreCorto, [IndVigencia] = @IndVigencia WHERE [CodDepartamentosSENAME] = @CodDepartamentosSENAME">
                            <DeleteParameters>
                                <asp:Parameter Name="CodDepartamentosSENAME" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodDepartamentosSENAME" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parDepartamentosSENAME] ([Nombre], [NombreCorto], [IndVigencia]) VALUES (@Nombre, @NombreCorto, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodDepartamentosSENAME], [Nombre], [NombreCorto], [IndVigencia] FROM [parDepartamentosSENAME]"
                            UpdateCommand="UPDATE [parDepartamentosSENAME] SET [Nombre] = @Nombre, [NombreCorto] = @NombreCorto, [IndVigencia] = @IndVigencia WHERE [CodDepartamentosSENAME] = @CodDepartamentosSENAME">
                            <DeleteParameters>
                                <asp:Parameter Name="CodDepartamentosSENAME" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parDepartamentosSENAME] ([Nombre], [NombreCorto], [IndVigencia]) VALUES (@Nombre, @NombreCorto, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parDepartamentosSENAME AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parDepartamentosSENAME] SET [Nombre] = @Nombre, [NombreCorto] = @NombreCorto, [IndVigencia] = @IndVigencia WHERE [CodDepartamentosSENAME] = @CodDepartamentosSENAME">
                            <InsertParameters>
                                <asp:Parameter Name="Nombre" Type="String" />
                                <asp:Parameter Name="NombreCorto" Type="String" />
                                ...
                                <tr>
                                    <td class="fondobordetabla" style="width: 578px">
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                            <tr>
                                                <td width="225" class="texto_form" style="width: 127px">Nombre</td>
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox2" runat="server" Width="650px" MaxLength="100" Font-Size="11px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="texto_form" style="width: 127px">Nombre Corto</td>
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox3" runat="server" Width="350px" MaxLength="50" Font-Bold="False" Font-Size="11px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
