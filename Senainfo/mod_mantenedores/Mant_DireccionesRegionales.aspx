<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_DireccionesRegionales.aspx.cs" Inherits="Mant_DireccionesRegionales" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Direcciones Regionales </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                        <tr>
                                            <td width="225" class="texto_form">Región</td>
                                            <td class="linea_inferior">
                                                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource4"
                                                    DataTextField="Descripcion" DataValueField="CodRegion" AutoPostBack="True" Font-Size="11px" Width="350px">
                                                </asp:DropDownList></td>
                                        </tr>
                                    </table>
                                </td>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodDireccionRegional" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="CodRegion">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox3" runat="server" Enabled="False" Text='<%# Bind("CodRegion") %>'
                                            Width="40px"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("CodRegion") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Font-Size="11px" />
                                </asp:TemplateField>
                                <asp:BoundField DataField="CodDireccionRegional" HeaderText="CodDireccionRegional"
                                    ReadOnly="True" SortExpression="CodDireccionRegional">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parDireccionesRegionales] WHERE [CodDireccionRegional] = @CodDireccionRegional"
                            InsertCommand="INSERT INTO [parDireccionesRegionales] ([Descripcion], [IndVigencia], [CodRegion]) VALUES (@Descripcion, @IndVigencia, @CodRegion)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodDireccionRegional], [Descripcion], [IndVigencia], [CodRegion] FROM [parDireccionesRegionales] WHERE (([CodRegion] = @CodRegion) AND ([Descripcion] LIKE '%' + @Descripcion + '%'))"
                            UpdateCommand="UPDATE [parDireccionesRegionales] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia, [CodRegion] = @CodRegion WHERE [CodDireccionRegional] = @CodDireccionRegional">
                            <DeleteParameters>
                                <asp:Parameter Name="CodDireccionRegional" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                            ...
                            <SelectParameters>
                                <asp:ControlParameter ControlID="DropDownList1" Name="CodRegion" PropertyName="SelectedValue"
                                    Type="Int16" />
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodDireccionRegional" DataSourceID="SqlDataSource2"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="CodRegion">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox4" runat="server" Enabled="False" Text='<%# Bind("CodRegion") %>'
                                            Width="40px"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("CodRegion") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Font-Size="11px" />
                                </asp:TemplateField>
                                <asp:BoundField DataField="CodDireccionRegional" HeaderText="CodDireccionRegional"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parDireccionesRegionales] ([Descripcion], [IndVigencia], [CodRegion]) VALUES (@Descripcion, @IndVigencia, @CodRegion)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodDireccionRegional], [Descripcion], [IndVigencia], [CodRegion] FROM [parDireccionesRegionales] WHERE ([CodRegion] = @CodRegion)"
                            UpdateCommand="UPDATE [parDireccionesRegionales] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia, [CodRegion] = @CodRegion WHERE [CodDireccionRegional] = @CodDireccionRegional">
                            <DeleteParameters>
                                <asp:Parameter Name="CodDireccionRegional" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parDireccionesRegionales] ([Descripcion], [IndVigencia], [CodRegion]) VALUES (@Descripcion, @IndVigencia, @CodRegion)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parDireccionesRegionales AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parDireccionesRegionales] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia, [CodRegion] = @CodRegion WHERE [CodDireccionRegional] = @CodDireccionRegional">
                            <DeleteParameters>
                                <asp:Parameter Name="CodDireccionRegional" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parRegion] WHERE [CodRegion] = @CodRegion" InsertCommand="INSERT INTO [parRegion] ([Descripcion], [PorcentajeAsignacionNL], [IndVigencia], [TipoFlujo]) VALUES (@Descripcion, @PorcentajeAsignacionNL, @IndVigencia, @TipoFlujo)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodRegion], [Descripcion], [PorcentajeAsignacionNL], [IndVigencia], [TipoFlujo] FROM [parRegion]"
                            UpdateCommand="UPDATE [parRegion] SET [Descripcion] = @Descripcion, [PorcentajeAsignacionNL] = @PorcentajeAsignacionNL, [IndVigencia] = @IndVigencia, [TipoFlujo] = @TipoFlujo WHERE [CodRegion] = @CodRegion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodRegion" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                                ...
                                <asp:Parameter Name="IndVigencia" Type="String" />
                                <asp:Parameter Name="TipoFlujo" Type="String" />
                                <asp:Parameter Name="CodRegion" Type="Int16" />
                            </UpdateParameters>
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
