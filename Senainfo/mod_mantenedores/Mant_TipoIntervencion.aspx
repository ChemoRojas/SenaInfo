<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_TipoIntervencion.aspx.cs" Inherits="Mant_TipoIntervencion" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Intervención </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoIntervencion" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="TipoIntervencion" HeaderText="TipoIntervencion" ReadOnly="True"
                                    SortExpression="TipoIntervencion">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTipoIntervencion] WHERE [TipoIntervencion] = @TipoIntervencion"
                            InsertCommand="INSERT INTO [parTipoIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoIntervencion], [Descripcion], [IndVigencia] FROM [parTipoIntervencion] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parTipoIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoIntervencion] = @TipoIntervencion">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoIntervencion" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoIntervencion" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoIntervencion], [Descripcion], [IndVigencia] FROM [parTipoIntervencion]"
                            UpdateCommand="UPDATE [parTipoIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoIntervencion] = @TipoIntervencion">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoIntervencion" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoIntervencion AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoIntervencion] = @TipoIntervencion">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoIntervencion" Type="Int16" />
                            </DeleteParameters>
