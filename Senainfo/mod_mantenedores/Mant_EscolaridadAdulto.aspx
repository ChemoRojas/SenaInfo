<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_EscolaridadAdulto.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Escolaridad Adulto </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodEscolaridadAdulto" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodEscolaridadAdulto" HeaderText="CodEscolaridadAdulto"
                                    ReadOnly="True" SortExpression="CodEscolaridadAdulto">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parEscolaridadAdulto] WHERE [CodEscolaridadAdulto] = @CodEscolaridadAdulto"
                            InsertCommand="INSERT INTO [parEscolaridadAdulto] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodEscolaridadAdulto], [Descripcion], [IndVigencia] FROM [parEscolaridadAdulto] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parEscolaridadAdulto] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodEscolaridadAdulto] = @CodEscolaridadAdulto">
                            <DeleteParameters>
                                <asp:Parameter Name="CodEscolaridadAdulto" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodEscolaridadAdulto" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parEscolaridadAdulto] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodEscolaridadAdulto], [Descripcion], [IndVigencia] FROM [parEscolaridadAdulto]"
                            UpdateCommand="UPDATE [parEscolaridadAdulto] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodEscolaridadAdulto] = @CodEscolaridadAdulto">
                            <DeleteParameters>
                                <asp:Parameter Name="CodEscolaridadAdulto" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parEscolaridadAdulto] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parEscolaridadAdulto AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parEscolaridadAdulto] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodEscolaridadAdulto] = @CodEscolaridadAdulto">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
