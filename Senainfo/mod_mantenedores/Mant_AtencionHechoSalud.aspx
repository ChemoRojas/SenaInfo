<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_AtencionHechoSalud.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantendor Atenci&oacute;n Hecho de Salud </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodAtencionHechoSalud" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodAtencionHechoSalud" HeaderText="CodAtencionHechoSalud"
                                    ReadOnly="True" SortExpression="CodAtencionHechoSalud">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parAtencionHechoSalud] WHERE [CodAtencionHechoSalud] = @CodAtencionHechoSalud"
                            InsertCommand="INSERT INTO [parAtencionHechoSalud] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodAtencionHechoSalud], [Descripcion], [IndVigencia] FROM [parAtencionHechoSalud] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parAtencionHechoSalud] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodAtencionHechoSalud] = @CodAtencionHechoSalud">
                            <DeleteParameters>
                                <asp:Parameter Name="CodAtencionHechoSalud" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodAtencionHechoSalud" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parAtencionHechoSalud] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodAtencionHechoSalud], [Descripcion], [IndVigencia] FROM [parAtencionHechoSalud]"
                            UpdateCommand="UPDATE [parAtencionHechoSalud] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodAtencionHechoSalud] = @CodAtencionHechoSalud">
                            <DeleteParameters>
                                <asp:Parameter Name="CodAtencionHechoSalud" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parAtencionHechoSalud] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parAtencionHechoSalud AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parAtencionHechoSalud] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodAtencionHechoSalud] = @CodAtencionHechoSalud">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                                        ...
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                            <tr>
                                                ...
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox2" runat="server" Width="650px" MaxLength="200" TextMode="MultiLine" Font-Names="Arial" Font-Size="11px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="texto_form">IndVigencia</td>
                                                <td class="linea_inferior">
                                                    <asp:DropDownList ID="DropDownList1" runat="server" Width="350px" Font-Size="11px">
