<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_PreguntasDiagnostico.aspx.cs" Inherits="mod_mantenedores_Mant_PreguntasDiagnostico" %>
...
<head id="Head1" runat="server">
    ...
    <title>Mantenedor de Preguntas de Diagnóstico :: Senainfo :: Servicio Nacional de Menores</title>
    ...
    <script type="text/javascript">
        ...
        function limpiarForm() {
            window.location = "Mant_PreguntasDiagnostico.aspx"
        }
    </script>
</head>
            ...
            <ContentTemplate>
                <div class="container theme-showcase" role="main">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Preguntas Diagnóstico</li>
                    </ol>
                    ...
                    <div class="alert alert-success text-center" role="alert" id="alertS" runat="server" visible="false">
                        ...
                        <asp:Label ID="lblMsgSuccess" runat="server" Text="Datos de la Pregunta registrados satisfactoriamente." Visible="false">Datos de la Pregunta registrados satisfactoriamente.</asp:Label>
                    </div>
                        ...
                        <div class="col-md-9">
                            <form action="">
                                <table class="table table-borderless table-condensed table-col-fix">
                                    <tr>
                                        <th class="col-md-3">
                                            <label for="">Código de Pregunta:</label>
                                        </th>
                                        <td>
                                            <div class="input-group">
                                                <asp:TextBox ID="txtCodPregunta" runat="server" onkeypress="return numbersonly(event);"></asp:TextBox>
                                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:Panel ID="panelInfoBusqueda" runat="server" CssClass="panel-info panel-primary-info">
                                ...
                                <div class="panel-footer">
                                    <asp:Label ID="Lbl_Info1" CssClass="subtitulo-form-info" runat="server" Text="Ingrese código de pregunta."></asp:Label><br />
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <asp:GridView ID="grdBusqueda" runat="server" AutoGenerateColumns="False" CellPadding="4" GridLines="None" CssClass="table table table-bordered table-hover">
                                ...
                                <Columns>
                                    <asp:BoundField DataField="CodPregunta" HeaderText="Código de la Pregunta" />
                                    <asp:BoundField DataField="Texto" HeaderText="Texto de la Pregunta" />
                                    <asp:BoundField DataField="NombreArea" HeaderText="Área de la Pregunta" />
                                    <asp:BoundField DataField="Orden" HeaderText="Orden de la Pregunta" />
                                    <asp:BoundField DataField="Tipo" HeaderText="Tipo de la Pregunta" />
                                    <asp:BoundField DataField="Vigencia" HeaderText="Vigencia" />
                                    <asp:BoundField DataField="CodPregunta" HtmlEncode="False" DataFormatString="<a href='editarRespuestaDiagnostico.aspx?CodPregunta={0}'>Editar</a>" HeaderText="Editar" ItemStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="CodPregunta" HtmlEncode="False" DataFormatString="<a href='Mant_PreguntasDiagnostico.aspx?CodPregunta={0}'>Cambiar Vigencia</a>" HeaderText="Cambiar Vigencia" ItemStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="CodPregunta" HtmlEncode="False" DataFormatString="<a href='Mant_RespuestasDiagnostico.aspx?CodPregunta={0}'>Ver Respuestas</a>" HeaderText="Editar" ItemStyle-HorizontalAlign="Center" />
                                </Columns>
                    ...
                    <div class="well" id="grabar" visible="false" runat="server">
                        <h4 class="subtitulo-form">Preguntas</h4>


                        <table class="table table-bordered  table-condensed">

                            <tr>
                                <th class="titulo-tabla" scope="row">Texto de la Pregunta *</th>
                                <td colspan="3" class="col-md-8">
                                    <asp:TextBox ID="txtTextoPregunta" runat="server" MaxLength="3500" CssClass="form-control input-sm" placeholder="Ingrese texto de la pregunta"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <th class="titulo-tabla" scope="row">Área de la Pregunta*</th>
                                <td colspan="3" class="col-md-8">
                                    <asp:DropDownList ID="CodAreaPregunta" runat="server" CssClass="form-control input-sm">
                                        <asp:ListItem Value="0">Seleccionar</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <th class="titulo-tabla" scope="row">Orden de la Pregunta *</th>
                                <td colspan="3" class="col-md-8">
                                    <asp:TextBox ID="txtOrdenPregunta" runat="server" MaxLength="100" CssClass="form-control input-sm" placeholder="Ingrese orden de la pregunta"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <th class="titulo-tabla" scope="row">Tipo de la Pregunta *</th>
                                <td colspan="3" class="col-md-8">
                                    <asp:TextBox ID="txtTipoPregunta" runat="server" MaxLength="100" CssClass="form-control input-sm" placeholder="Ingrese tipo de la pregunta"></asp:TextBox>
                                </td>
                            </tr>
