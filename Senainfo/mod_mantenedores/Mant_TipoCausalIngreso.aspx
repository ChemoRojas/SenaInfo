<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_TipoCausalIngreso.aspx.cs" Inherits="Mant_TipoCausalIngreso" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Causal Ingreso </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodTipoCausalIngreso" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodTipoCausalIngreso" HeaderText="CodTipoCausalIngreso"
                                    ReadOnly="True" SortExpression="CodTipoCausalIngreso">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            SelectCommand="SELECT [CodTipoCausalIngreso], [Descripcion], [IndVigencia], [EdadMinima] FROM [parTipoCausalIngreso] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodTipoCausalIngreso" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoCausalIngreso] ([Descripcion], [IndVigencia], [EdadMinima]) VALUES (@Descripcion, @IndVigencia, @EdadMinima)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoCausalIngreso AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoCausalIngreso] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia, [EdadMinima] = @EdadMinima WHERE [CodTipoCausalIngreso] = @CodTipoCausalIngreso">
                            <DeleteParameters>
                                <asp:Parameter Name="CodTipoCausalIngreso" Type="Int16" />
                            </DeleteParameters>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                            ...
                                            <tr>
                                                <td class="texto_form">Edad Minima</td>
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox3" runat="server" Width="50px" MaxLength="5" Font-Size="11px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
