<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_RespuestasDiagnostico.aspx.cs" Inherits="mod_mantenedores_Mant_RespuestasDiagnostico" %>
...
<head id="Head1" runat="server">
    ...
    <title>Mantenedor de Respuestas de Diagnóstico :: Senainfo :: Servicio Nacional de Menores</title>
    ...
    <script type="text/javascript">
        ...
        function limpiarForm() {
            window.location = "Mant_RespuestasDiagnostico.aspx"
        }
    </script>
</head>
            ...
            <ContentTemplate>
                <div class="container theme-showcase" role="main">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Respuestas Diagnóstico</li>
                    </ol>
                    ...
                    <div class="alert alert-success text-center" role="alert" id="alertS" runat="server" visible="false">
                        ...
                        <asp:Label ID="lblMsgSuccess" runat="server" Text="Datos de la Respuesta registrados satisfactoriamente." Visible="false">Datos de la Pregunta registrados satisfactoriamente.</asp:Label>
                    </div>
                        ...
                        <div class="col-md-9">
                            <form action="">
                                <table class="table table-borderless table-condensed table-col-fix">
                                    <tr>
                                        <th class="col-md-3">
                                            <label for="">Código de Respuesta:</label>
                                        </th>
                                        <td>
                                            <div class="input-group">
                                                <asp:TextBox ID="txtCodRespuesta" runat="server" onkeypress="return numbersonly(event);"></asp:TextBox>
                                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:Panel ID="panelInfoBusqueda" runat="server" CssClass="panel-info panel-primary-info">
                                ...
                                <div class="panel-footer">
                                    <asp:Label ID="Lbl_Info1" CssClass="subtitulo-form-info" runat="server" Text="Ingrese código de respuesta."></asp:Label><br />
                        ...
                        <div class="col-md-9">
                            ...
                            <asp:GridView ID="grdBusqueda" runat="server" AutoGenerateColumns="False" CellPadding="4" GridLines="None" CssClass="table table table-bordered table-hover">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Puntaje" HeaderText="Puntaje de la Pregunta" />
                                    <asp:BoundField DataField="Tipo" HeaderText="Tipo de la Pregunta" />
                                    <asp:BoundField DataField="Vigencia" HeaderText="Vigencia" />
                                    <asp:BoundField DataField="CodPregunta" HtmlEncode="False" DataFormatString="<a href='editarRespuestaDiagnostico.aspx?CodHerramienta={0}'>Editar</a>" HeaderText="Editar" ItemStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="CodPregunta" HtmlEncode="False" DataFormatString="<a href='Mant_PreguntasDiagnostico.aspx?CodHerramienta={0}'>Cambiar Vigencia</a>" HeaderText="Cambiar Vigencia" ItemStyle-HorizontalAlign="Center" />
                                </Columns>
