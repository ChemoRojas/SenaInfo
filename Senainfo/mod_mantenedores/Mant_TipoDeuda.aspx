<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_TipoDeuda.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Deuda </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodTipoDeuda" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodTipoDeuda" HeaderText="CodTipoDeuda" ReadOnly="True"
                                    SortExpression="CodTipoDeuda">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Descripcion" HeaderText="Descripcion" SortExpression="Descripcion">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                                <asp:CheckBoxField DataField="Directa" HeaderText="Directa" SortExpression="Directa">
                                    <ItemStyle Font-Size="11px" />
                                </asp:CheckBoxField>
                                <asp:CheckBoxField DataField="Automatica" HeaderText="Automatica" SortExpression="Automatica">
                                    <ItemStyle Font-Size="11px" />
                                </asp:CheckBoxField>
                                <asp:BoundField DataField="CreditoDebito" HeaderText="CreditoDebito" SortExpression="CreditoDebito">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTipoDeuda] WHERE [CodTipoDeuda] = @CodTipoDeuda"
                            InsertCommand="INSERT INTO [parTipoDeuda] ([Descripcion], [Directa], [Automatica], [CreditoDebito], [IndVigencia]) VALUES (@Descripcion, @Directa, @Automatica, @CreditoDebito, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodTipoDeuda], [Descripcion], [Directa], [Automatica], [CreditoDebito], [IndVigencia] FROM [parTipoDeuda] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parTipoDeuda] SET [Descripcion] = @Descripcion, [Directa] = @Directa, [Automatica] = @Automatica, [CreditoDebito] = @CreditoDebito, [IndVigencia] = @IndVigencia WHERE [CodTipoDeuda] = @CodTipoDeuda">
                            <DeleteParameters>
                                <asp:Parameter Name="CodTipoDeuda" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="Directa" Type="Boolean" />
                                <asp:Parameter Name="Automatica" Type="Boolean" />
                                <asp:Parameter Name="CreditoDebito" Type="Int16" />
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodTipoDeuda" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoDeuda] ([Descripcion], [Directa], [Automatica], [CreditoDebito], [IndVigencia]) VALUES (@Descripcion, @Directa, @Automatica, @CreditoDebito, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodTipoDeuda], [Descripcion], [Directa], [Automatica], [CreditoDebito], [IndVigencia] FROM [parTipoDeuda]"
                            UpdateCommand="UPDATE [parTipoDeuda] SET [Descripcion] = @Descripcion, [Directa] = @Directa, [Automatica] = @Automatica, [CreditoDebito] = @CreditoDebito, [IndVigencia] = @IndVigencia WHERE [CodTipoDeuda] = @CodTipoDeuda">
                            <DeleteParameters>
                                <asp:Parameter Name="CodTipoDeuda" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoDeuda] ([Descripcion], [Directa], [Automatica], [CreditoDebito], [IndVigencia]) VALUES (@Descripcion, @Directa, @Automatica, @CreditoDebito, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoDeuda AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoDeuda] SET [Descripcion] = @Descripcion, [Directa] = @Directa, [Automatica] = @Automatica, [CreditoDebito] = @CreditoDebito, [IndVigencia] = @IndVigencia WHERE [CodTipoDeuda] = @CodTipoDeuda">
                            <DeleteParameters>
                                <asp:Parameter Name="CodTipoDeuda" Type="Int16" />
                            </DeleteParameters>
