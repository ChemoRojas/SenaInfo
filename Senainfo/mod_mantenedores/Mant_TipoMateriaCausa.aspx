<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_TipoMateriaCausa.aspx.cs" Inherits="Mant_TipoMateriaCausa" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Materia Causal </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoMateriaCausa" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="TipoMateriaCausa" HeaderText="TipoMateriaCausa" ReadOnly="True"
                                    SortExpression="TipoMateriaCausa">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            SelectCommand="SELECT [TipoMateriaCausa], [Descripcion], [IndVigencia] FROM [parTipoMateriaCausa] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoMateriaCausa" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoMateriaCausa] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoMateriaCausa AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoMateriaCausa] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoMateriaCausa] = @TipoMateriaCausa">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoMateriaCausa" Type="Int16" />
                            </DeleteParameters>
