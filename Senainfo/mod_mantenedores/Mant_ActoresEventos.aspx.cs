...
public partial class Default3 : System.Web.UI.Page
{
    ...
    protected void ImageButton2_Click1(object sender, ImageClickEventArgs e)
    {
        ...
        if (CheckBox1.Checked == true)
            SqlDataSource2.InsertParameters["Automatico"].DefaultValue = Convert.ToString(Convert.ToBoolean(1));
        else
            SqlDataSource2.InsertParameters["Automatico"].DefaultValue = Convert.ToString(Convert.ToBoolean(0));
