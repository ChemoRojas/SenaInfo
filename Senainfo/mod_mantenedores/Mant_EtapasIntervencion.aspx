<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_EtapasIntervencion.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Etapas Intervenci&oacute;n </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodEtapasIntervencion" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodEtapasIntervencion" HeaderText="CodEtapasIntervencion"
                                    ReadOnly="True" SortExpression="CodEtapasIntervencion">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parEtapasIntervencion] WHERE [CodEtapasIntervencion] = @CodEtapasIntervencion"
                            InsertCommand="INSERT INTO [parEtapasIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodEtapasIntervencion], [Descripcion], [IndVigencia] FROM [parEtapasIntervencion] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parEtapasIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodEtapasIntervencion] = @CodEtapasIntervencion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodEtapasIntervencion" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodEtapasIntervencion" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parEtapasIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodEtapasIntervencion], [Descripcion], [IndVigencia] FROM [parEtapasIntervencion]"
                            UpdateCommand="UPDATE [parEtapasIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodEtapasIntervencion] = @CodEtapasIntervencion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodEtapasIntervencion" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parEtapasIntervencion] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parEtapasIntervencion AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parEtapasIntervencion] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodEtapasIntervencion] = @CodEtapasIntervencion">
                            <DeleteParameters>
                                <asp:Parameter Name="CodEtapasIntervencion" Type="Int16" />
                            </DeleteParameters>
