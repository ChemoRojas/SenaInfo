<%@ Page Language="C#" Culture="es-CL" UICulture="es" AutoEventWireup="true" CodeFile="Mant_TipoRelacionIntervencionEgreso.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Relaci&oacute;n Intervenci&oacute;n Egreso </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:Button CssClass="BtnSenaInfo-01 BtnSenaInfo-01-azul" ID="ImageButton1" runat="server" Text="Buscar" OnClick="ImageButton1_Click" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoRelacionIntervencionEgreso" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="TipoRelacionIntervencionEgreso" HeaderText="TipoRelacionIntervencionEgreso"
                                    ReadOnly="True" SortExpression="TipoRelacionIntervencionEgreso">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTipoRelacionIntervencionEgreso] WHERE [TipoRelacionIntervencionEgreso] = @TipoRelacionIntervencionEgreso"
                            InsertCommand="INSERT INTO [parTipoRelacionIntervencionEgreso] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoRelacionIntervencionEgreso], [Descripcion], [IndVigencia] FROM [parTipoRelacionIntervencionEgreso] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parTipoRelacionIntervencionEgreso] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoRelacionIntervencionEgreso] = @TipoRelacionIntervencionEgreso">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoRelacionIntervencionEgreso" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoRelacionIntervencionEgreso" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoRelacionIntervencionEgreso] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoRelacionIntervencionEgreso], [Descripcion], [IndVigencia] FROM [parTipoRelacionIntervencionEgreso]"
                            UpdateCommand="UPDATE [parTipoRelacionIntervencionEgreso] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoRelacionIntervencionEgreso] = @TipoRelacionIntervencionEgreso">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoRelacionIntervencionEgreso" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoRelacionIntervencionEgreso] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoRelacionIntervencionEgreso AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoRelacionIntervencionEgreso] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoRelacionIntervencionEgreso] = @TipoRelacionIntervencionEgreso">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
