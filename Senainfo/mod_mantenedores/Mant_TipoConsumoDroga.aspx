<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_TipoConsumoDroga.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Consumo Droga </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoConsumoDroga" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="TipoConsumoDroga" HeaderText="TipoConsumoDroga" ReadOnly="True"
                                    SortExpression="TipoConsumoDroga">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTipoConsumoDroga] WHERE [TipoConsumoDroga] = @TipoConsumoDroga"
                            InsertCommand="INSERT INTO [parTipoConsumoDroga] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoConsumoDroga], [Descripcion], [IndVigencia] FROM [parTipoConsumoDroga] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parTipoConsumoDroga] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoConsumoDroga] = @TipoConsumoDroga">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoConsumoDroga" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoConsumoDroga" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoConsumoDroga] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoConsumoDroga], [Descripcion], [IndVigencia] FROM [parTipoConsumoDroga]"
                            UpdateCommand="UPDATE [parTipoConsumoDroga] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoConsumoDroga] = @TipoConsumoDroga">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parTipoConsumoDroga] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoConsumoDroga RIGHT OUTER JOIN dbo.parDominios AS pD ON dbo.parTipoConsumoDroga.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoConsumoDroga] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoConsumoDroga] = @TipoConsumoDroga">
                            <InsertParameters>
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
