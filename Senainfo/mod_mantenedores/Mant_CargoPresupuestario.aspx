<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_CargoPresupuestario.aspx.cs" Inherits="Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor sw Cargo Presupuestario </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodAsignacionPresupuestaria" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CodAsignacionPresupuestaria" HeaderText="CodAsignacionPresupuestaria"
                                    ReadOnly="True" SortExpression="CodAsignacionPresupuestaria">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="CodAsignacionInterna" HeaderText="CodAsignacionInterna"
                                    SortExpression="CodAsignacionInterna">
                                    <ItemStyle Font-Size="11px" />
                                </asp:BoundField>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parCargoPresupuestario] WHERE [CodAsignacionPresupuestaria] = @CodAsignacionPresupuestaria"
                            InsertCommand="INSERT INTO [parCargoPresupuestario] ([CodAsignacionInterna], [Descripcion], [IndVigencia]) VALUES (@CodAsignacionInterna, @Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodAsignacionPresupuestaria], [CodAsignacionInterna], [Descripcion], [IndVigencia] FROM [parCargoPresupuestario] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parCargoPresupuestario] SET [CodAsignacionInterna] = @CodAsignacionInterna, [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodAsignacionPresupuestaria] = @CodAsignacionPresupuestaria">
                            <InsertParameters>
                                <asp:Parameter Name="CodAsignacionInterna" Type="Int32" />
                            ...
                            <UpdateParameters>
                                ...
                                <asp:Parameter Name="Descripcion" Type="String" />
                                <asp:Parameter Name="IndVigencia" Type="String" />
                                <asp:Parameter Name="CodAsignacionPresupuestaria" Type="Int16" />
                            </UpdateParameters>
                            <DeleteParameters>
                                <asp:Parameter Name="CodAsignacionPresupuestaria" Type="Int16" />
                            </DeleteParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="CodAsignacionPresupuestaria" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parCargoPresupuestario] ([CodAsignacionInterna], [Descripcion], [IndVigencia]) VALUES (@CodAsignacionInterna, @Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [CodAsignacionPresupuestaria], [CodAsignacionInterna], [Descripcion], [IndVigencia] FROM [parCargoPresupuestario]"
                            UpdateCommand="UPDATE [parCargoPresupuestario] SET [CodAsignacionInterna] = @CodAsignacionInterna, [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodAsignacionPresupuestaria] = @CodAsignacionPresupuestaria">
                            <InsertParameters>
                                <asp:Parameter Name="CodAsignacionInterna" Type="Int32" />
                                <asp:Parameter Name="Descripcion" Type="String" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            ...
                            InsertCommand="INSERT INTO [parCargoPresupuestario] ([CodAsignacionInterna], [Descripcion], [IndVigencia]) VALUES (@CodAsignacionInterna, @Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parCargoPresupuestario AS p RIGHT OUTER JOIN dbo.parDominios AS pD ON p.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parCargoPresupuestario] SET [CodAsignacionInterna] = @CodAsignacionInterna, [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [CodAsignacionPresupuestaria] = @CodAsignacionPresupuestaria">
                            <InsertParameters>
                                <asp:Parameter Name="CodAsignacionInterna" Type="Int32" />
                                <asp:Parameter Name="Descripcion" Type="String" />
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                            ...
                                            <tr>
                                                <td class="texto_form">C&oacute;digo de Asignaci&oacute;n Interna</td>
                                                <td class="linea_inferior">
                                                    <asp:TextBox ID="TextBox3" runat="server" Width="100px" MaxLength="50" Font-Size="11px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
