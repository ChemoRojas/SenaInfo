<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mant_TipoCargo.aspx.cs" Inherits="Mant_TipoCargo" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="titulo_form">Mantenedor de Tipo Cargo </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoCargo" DataSourceID="SqlDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="TipoCargo" HeaderText="TipoCargo" ReadOnly="True" SortExpression="TipoCargo">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTipoCargo] WHERE [TipoCargo] = @TipoCargo" InsertCommand="INSERT INTO [parTipoCargo] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoCargo], [Descripcion], [IndVigencia] FROM [parTipoCargo]"
                            UpdateCommand="UPDATE [parTipoCargo] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoCargo] = @TipoCargo">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoCargo" Type="Int16" />
                            </DeleteParameters>
                            <UpdateParameters>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                            AutoGenerateColumns="False" DataKeyNames="TipoCargo" DataSourceID="SqlDataSource2"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTipoCargo] WHERE [TipoCargo] = @TipoCargo" InsertCommand="INSERT INTO [parTipoCargo] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT [TipoCargo], [Descripcion], [IndVigencia] FROM [parTipoCargo] WHERE ([Descripcion] LIKE '%' + @Descripcion + '%')"
                            UpdateCommand="UPDATE [parTipoCargo] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoCargo] = @TipoCargo">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoCargo" Type="Int16" />
                            </DeleteParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:RegMenMigracionConnectionString1 %>"
                            DeleteCommand="DELETE FROM [parTipoCargo] WHERE [TipoCargo] = @TipoCargo" InsertCommand="INSERT INTO [parTipoCargo] ([Descripcion], [IndVigencia]) VALUES (@Descripcion, @IndVigencia)"
                            ProviderName="<%$ ConnectionStrings:RegMenMigracionConnectionString1.ProviderName %>"
                            SelectCommand="SELECT DISTINCT pD.Tabla_Descripcion, pD.Tabla_Valor FROM dbo.parTipoCargo RIGHT OUTER JOIN dbo.parDominios AS pD ON dbo.parTipoCargo.IndVigencia = pD.Tabla_Valor WHERE (pD.IdTabla = 'ESTADO')"
                            UpdateCommand="UPDATE [parTipoCargo] SET [Descripcion] = @Descripcion, [IndVigencia] = @IndVigencia WHERE [TipoCargo] = @TipoCargo">
                            <DeleteParameters>
                                <asp:Parameter Name="TipoCargo" Type="Int16" />
                            </DeleteParameters>
