...
public partial class mod_mantenedores_Mant_Modulos : System.Web.UI.Page
{
    public int vCodPaso
    {
            ...
            else
            {
                ...
                try
                {
                    ...
                    while (datareader1.Read())
                    {
                        ...
                        String NombreModulo = (String)datareader1["NombreModulo"];
                        String CodigoObjetivo = Convert.ToString((int)datareader1["CodObjetivo"]);
                        ...
                        if (codmodulo != "0" || codmodulo != "")
                        {
                            ...
                            con.parametros("@CodModulo", SqlDbType.Int, 4, codmodulo) , 
                            con.parametros("@CodObjetivo", SqlDbType.Int, 4, CodigoObjetivo) , 
		                    con.parametros("@NombreModulo", SqlDbType.VarChar, 30, NombreModulo),
    ...
    private void guardarObjetivo()
    {
        ...
        Conexiones con = new Conexiones();
        DbParameter[] parametros = {
        con.parametros("@CodModulo", SqlDbType.Int, 4, 0) , 
    ...
    private DataTable resultadoBusqueda(string CodModulo)
    {
        Conexiones con = new Conexiones();
        ...
        sqlc.CommandText = "EXEC [dbo].[SP_getModuloBusqueda] '" + CodModulo + "' ";
    ...
    {
        DataTable dt1 = resultadoBusqueda(txtCodModulo.Text);
