...
/// <summary>
/// Descripción breve de AlertaListaEsperaPorAbuso
/// </summary>
public class AlertaListaEsperaPorAbuso : IAlertas
{
    SqlConnection sqlc = new SqlConnection(ConfigurationManager.ConnectionStrings["Conexiones"].ToString());

	public AlertaListaEsperaPorAbuso()
	{
		//
  ...
  public bool ActualizarAlerta(Alerta alerta)
  {
      ...
      try
      {
          ...
          alerta.Cua = "LEPAS_" + alerta.CodNino;
