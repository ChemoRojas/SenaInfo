...
/// <summary>
/// Descripción breve de ConexionesSS
/// </summary>
public class ConexionesSS
{
    SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConexionesSS"].ToString());
