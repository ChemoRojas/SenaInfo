<%@ Page Language="C#" AutoEventWireup="true" CodeFile="buscadorDiagnostico.aspx.cs" Inherits="buscador" %>
                            ...
                            <hr>
                                ...
                                <asp:Panel ID="panelInfoBusqueda" runat="server" CssClass="panel-info panel-primary-info">
                                    ...
                                    <div class="panel-footer">
                                        <asp:Label ID="Lbl_Info1" CssClass="subtitulo-form-info" runat="server" Text="Bucador de NNA para realizar Diagnóstico" ></asp:Label><br />
                                        ...
                                        <asp:Panel ID="lbl002panel" runat="server" Visible="false" CssClass="text-center">
                                            ...
                                            <asp:Label ID="lbl002" runat="server">0</asp:Label></label></h4>
                                                    ...
                                                    <asp:GridView ID="grdBusqueda" runat="server" AutoGenerateColumns="False" CellPadding="4" GridLines="None" CssClass="table table table-bordered table-hover"
                                                        AllowPaging="false" OnPageIndexChanging="grdBusqueda_PageIndexChanging" PageSize="10">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:hyperlinkfield text="Realizar Diagnóstico" datanavigateurlfields="CodNino,Ruc" datanavigateurlformatstring="DiagnosticoNino.aspx?CodNino={0}&amp;Ruc={1}" HeaderText="Seleccionar" ItemStyle-HorizontalAlign="Center" />
                                                        </Columns>
