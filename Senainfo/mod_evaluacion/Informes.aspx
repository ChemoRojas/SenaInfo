<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Informes.aspx.cs" Inherits="mod_evaluacion_Informes" %>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <asp:GridView ID="grdIntervencion" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="table table table-bordered table-hover"
                                            ShowHeaderWhenEmpty="true" EmptyDataText="El NNA consultado no posee un Diagnóstico vigentes." OnDataBound="grdIntervencion_DataBound" >
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="porcentaje2" HeaderText="Cumplimiento Objetivo" dataformatstring="{0:0.00}%"/>
                                                 ...
                                                 <asp:TemplateField HeaderText="Código Modulo" Visible="false">
                                                                <ItemTemplate>
                                                                   
                                                                    <asp:TextBox id="TxtPorcentajePII" Text='<%# Bind("porcentajePII") %>' runat="server" Visible="false"></asp:TextBox>
                                    ...
                                    <h4 style="text-align:center"><span> Cumplimiento PII: <label id="PorcentajeFinal" runat="server"></label>%</span></h4>
