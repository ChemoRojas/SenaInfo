<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuscadorInformes.aspx.cs" Inherits="mod_evaluacion_BuscadorInformes" %>
                ...
                <div>
                    ...
                    <div class="container theme-showcase" role="main">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Búsqueda de Informes</li>
                        </ol>
                        
                        <div class="well">

                            <h4 class="subtitulo-form">Búsqueda de Informes</h4>
                            <hr>
                                            ...
                                            <asp:Label ID="lbl002" runat="server">0</asp:Label></label></h4>
                                                    ...
                                                    <asp:GridView ID="grdBusqueda" runat="server" AutoGenerateColumns="False" CellPadding="4" GridLines="None" CssClass="table table table-bordered table-hover"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:hyperlinkfield text="Informe Avances" datanavigateurlfields="CodNino,Ruc" datanavigateurlformatstring="Informes.aspx?CodNino={0}&amp;Ruc={1}" HeaderText="Seleccionar" ItemStyle-HorizontalAlign="Center" />
                                                            <asp:hyperlinkfield text="Informe Tipo" datanavigateurlfields="CodNino,Ruc" datanavigateurlformatstring="InformeTipo.aspx?CodNino={0}&amp;Ruc={1}" HeaderText="Seleccionar" ItemStyle-HorizontalAlign="Center" />
                                                        </Columns>
                                                    </asp:GridView>
