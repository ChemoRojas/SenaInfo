<%@ Page Language="C#" AutoEventWireup="true" CodeFile="e403.aspx.cs" Inherits="e403" %>
...
<head id="Head1" runat="server">
    ...
    <title>Error 403 :: Senainfo :: Servicio Nacional de Menores</title>
            ...
            <ContentTemplate>
                ...
                <div class="container theme-showcase" role="main">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Error <strong>403</strong></li>
                    </ol>
                    ...
                    <div class="well">
                        <h4 class="subtitulo-form">Error 403</h4>
                        <hr>

                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-borderless table-condensed table-col-fix">
                                    <h2 class="text-center">Su Rol no tiene permiso para acceder a este recurso.</h2>
                                </table>
                            </div>
