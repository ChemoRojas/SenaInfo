...
public partial class mod_jueces_NNAVigentesDEPRODE : System.Web.UI.Page
{
    ...
    private void GetData()
    {
        ...
        con.Autenticar();
        dt = con.TraerDataTable("VIGENTES_NNA_MINJUSTICIA_DEPRODE", txt_run.Text.Replace(".", "").ToString(), txt_apaterno.Text.ToString(), txt_amaterno.Text.ToString(), txt_nombres.Text.ToString());
    ...
    protected void lnb_ExportarExcel_Click(object sender, EventArgs e)
    {
        ...
        string FileName = "NNAVigentesDEPRODE.xls";
