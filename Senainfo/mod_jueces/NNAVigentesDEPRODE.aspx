<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NNAVigentesDEPRODE.aspx.cs" Inherits="mod_jueces_NNAVigentesDEPRODE" %>
...
<head id="Head1" runat="server">
    ...
    <title>NNA Vigentes DEPRODE :: Senainfo :: Servicio Nacional de Menores</title>
            ...
            <ContentTemplate>
                ...
                <div class="container theme-showcase" role="main">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">NNA Vigentes DEPRODE</li>
                    </ol>
                    ...
                    <div class="well">
                        <h4 class="subtitulo-form">NNA Vigentes DEPRODE</h4>
                        <hr>
                                ...
                                <div class="fixed-header-table-container">
                                    ...
                                    <asp:GridView ID="grd_resultado" CssClass="table table-bordered table-hover caja-tabla " runat="server" Visible="False" onAutoGenerateColumns="False" AutoGenerateColumns="False">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CausalIngreso" HeaderText="CausalIngreso" AccessibleHeaderText="CausalIngreso"></asp:BoundField>
                                        </Columns>
                                        <HeaderStyle CssClass="titulo-tabla" />
                                        <PagerStyle CssClass="titulo-tabla" ForeColor="White" />
                                    </asp:GridView>

                                    <asp:GridView ID="grd_excel" runat="server" Visible="false" onAutoGenerateColumns="False" AutoGenerateColumns="False">
                                        <Columns>
                                            <asp:BoundField DataField="ICodIE" HeaderText="ICodIE" AccessibleHeaderText="ICodIE"></asp:BoundField>
                                            <asp:BoundField DataField="CodNino" HeaderText="CodNino" AccessibleHeaderText="CodNino"></asp:BoundField>
                                            <asp:BoundField DataField="CodProyecto" HeaderText="CodProyecto" AccessibleHeaderText="CodProyecto"></asp:BoundField>
                                            <asp:BoundField DataField="Nombre" HeaderText="Nombre" AccessibleHeaderText="Nombre"></asp:BoundField>
                                            <asp:BoundField DataField="ModeloIntervencion" HeaderText="ModeloIntervencion" AccessibleHeaderText="ModeloIntervencion"></asp:BoundField>
                                            <asp:BoundField DataField="FechaIngreso" HeaderText="FechaIngreso" AccessibleHeaderText="FechaIngreso" DataFormatString="{0:dd/MM/yyyy}"></asp:BoundField>
                                            <asp:BoundField DataField="rut" HeaderText="rut" AccessibleHeaderText="rut"></asp:BoundField>
                                            <asp:BoundField DataField="Apellido_Paterno" HeaderText="Apellido_Paterno" AccessibleHeaderText="Apellido_Paterno"></asp:BoundField>
                                            <asp:BoundField DataField="Apellido_Materno" HeaderText="Apellido_Materno" AccessibleHeaderText="Apellido_Materno"></asp:BoundField>
                                            ...
                                            <asp:BoundField DataField="Tribunal" HeaderText="Tribunal" AccessibleHeaderText="Tribunal"></asp:BoundField>
                                            <asp:BoundField DataField="CausalIngreso" HeaderText="CausalIngreso" AccessibleHeaderText="CausalIngreso"></asp:BoundField>
                                            <asp:BoundField DataField="Prioridad" HeaderText="Prioridad" AccessibleHeaderText="Prioridad"></asp:BoundField>
                                            <asp:BoundField DataField="CalidadJuridica" HeaderText="CalidadJuridica" AccessibleHeaderText="CalidadJuridica"></asp:BoundField>
                                            <asp:BoundField DataField="Diagnostico_Escolar" HeaderText="Diagnostico_Escolar" AccessibleHeaderText="Diagnostico_Escolar"></asp:BoundField>
                                            <asp:BoundField DataField="Diagnostico_Social" HeaderText="Diagnostico_Social" AccessibleHeaderText="Diagnostico_Social"></asp:BoundField>
                                            <asp:BoundField DataField="Diagnostico_Droga" HeaderText="Diagnostico_Droga" AccessibleHeaderText="Diagnostico_Droga"></asp:BoundField>
                                            <asp:BoundField DataField="Diagnostico_Capacitacion" HeaderText="Diagnostico_Capacitacion" AccessibleHeaderText="Diagnostico_Capacitacion"></asp:BoundField>
                                            <asp:BoundField DataField="Diagnostico_SituacionLaboral" HeaderText="Diagnostico_SituacionLaboral" AccessibleHeaderText="Diagnostico_SituacionLaboral"></asp:BoundField>
                                            <asp:BoundField DataField="Diagnostico_PFTI" HeaderText="Diagnostico_PFTI" AccessibleHeaderText="Diagnostico_PFTI"></asp:BoundField>
                                            <asp:BoundField DataField="PII" HeaderText="PII" AccessibleHeaderText="PII"></asp:BoundField>
                                            <asp:BoundField DataField="Discapacidad" HeaderText="Discapacidad" AccessibleHeaderText="Discapacidad"></asp:BoundField>
                                            <asp:BoundField DataField="EnfermedadCronica" HeaderText="EnfermedadCronica" AccessibleHeaderText="EnfermedadCronica"></asp:BoundField>
                                            <asp:BoundField DataField="HechosSalud" HeaderText="HechosSalud" AccessibleHeaderText="HechosSalud"></asp:BoundField>
                                            <asp:BoundField DataField="EdadAño" HeaderText="EdadAño" AccessibleHeaderText="EdadAño"></asp:BoundField>
                                            <asp:BoundField DataField="PermanenciaAño" HeaderText="PermanenciaAño" AccessibleHeaderText="PermanenciaAño"></asp:BoundField>
                                            <asp:BoundField DataField="PermanenciaMeses" HeaderText="PermanenciaMeses" AccessibleHeaderText="PermanenciaMeses"></asp:BoundField>
                                        </Columns>
                                        <HeaderStyle CssClass="titulo-tabla" />
                                        <PagerStyle CssClass="titulo-tabla" ForeColor="White" />
                                    </asp:GridView>
