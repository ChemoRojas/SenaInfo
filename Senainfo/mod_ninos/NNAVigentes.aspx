<%@ Page Language="C#" Culture="es-CL" UICulture="es"    AutoEventWireup="true" CodeFile="NNAVigentes.aspx.cs" Inherits="NinosEnProyecto" %>
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> NNA Vigentes</h3>
                            </div>
                            <br />
                            <div class="ui-widget">
                            <div class="col-sm-8">
                        ...
                        <div class="panel-body">
                            <ul id="listado" runat="server">
                                <li>
                                    <a href="#" id="p1" runat="server">Haga click para listar todos los NNA <span class="badge"><asp:Literal ID="CantidadNNA" runat="server"></asp:Literal></span></a>
                                </li>
                                    <%-- <ul><li>...</li> --%>
