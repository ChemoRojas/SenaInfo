<%@ Page Language="C#" AutoEventWireup="true"
    ...
    CodeBehind="wf_JusticiaJuvenilSupervision.aspx.cs"
    Inherits="Historico.JusticiaJuvenil.mod_historico_wf_JusticiaJuvenilSupervision" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleHead" runat="Server">
    Justicia Juvenil - Supervisión :: Sistema Histórico :: Servicio Nacional de Menores
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BreadcrumbContent" runat="Server">
    ...
    <li class="active"><strong>Justicia Juvenil - Supervisión</strong></li>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="Server">
            <asp:UpdatePanel ID="up_JusticiaJuvenilSupervision" runat="server" ChildrenAsTriggers="true">
                    ...
                    <div class="well" runat="server" id="PnelInformes" visible="false">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-9">
                                        <asp:LinkButton id="Lnk_LRPA" OnClick="LRPA_ServerClick" runat="server" style="font-size:11pt;color:blue;">Informes LRPA</asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                        <h5 class="subtitulo-form">
                        <img src="../../images/pdf-ico.png" />&nbsp Reportes PDF</h5>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-9">
                                        <asp:LinkButton id="Lnk_LRPAPDF" OnClick="LRPAPDF_ServerClick" runat="server" style="font-size:11pt;color:blue;">Reportes LRPA</asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <asp:LinkButton runat="server" ID="LinkButton2" CssClass="btn btn-info btn-sm pull-right" OnClick="MuestraPnelInformes" Text="">
                                            <span class="glyphicon glyphicon-arrow-left"></span>&nbsp <asp:Label ID="LblBotonVolver" runat="server"></asp:Label>
                                    </asp:LinkButton>
                                </div>
                            </div>
                        </div>
...
<%--                    <div class="well" runat="server" id="PnelReportes" visible="false">
                        <h5 class="subtitulo-form">
                        <img src="../../images/pdf-ico.png" />&nbsp Reportes PDF</h5>
                        <br />
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-9">
                                        <a id="LRPAPDF" onserverclick="LRPAPDF_ServerClick" runat="server" style="font-size:11pt;color:blue;">LRPA</a>
                                    </div>
                                </div>
                            </div>
                        </div>
